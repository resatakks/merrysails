...
const UI: Record<GuideLangCode, UIStrings> = {
  en: { tap: "Tap a landmark on the strait", lookFor: "What to look for", listen: "Listen to this landmark", stop: "Stop audio guide", prev: "Previous", next: "Next", europe: "European shore", asia: "Asian shore", strait: "Mid-strait", cta: "Book the Bosphorus sunset cruise", audioLang: "Guide language" },
  tr: { tap: "Boğaz haritasında bir noktaya dokun", lookFor: "Nereye bakmalı", listen: "Bu noktayı dinle", stop: "Sesli rehberi durdur", prev: "Önceki", next: "Sonraki", europe: "Avrupa yakası", asia: "Anadolu yakası", strait: "Boğazın ortası", cta: "Boğaz gün batımı turunu ayırt", audioLang: "Rehber dili" },
  de: { tap: "Tippen Sie auf ein Wahrzeichen am Bosporus", lookFor: "Worauf zu achten ist", listen: "Dieses Wahrzeichen anhören", stop: "Audioguide stoppen", prev: "Zurück", next: "Weiter", europe: "Europäisches Ufer", asia: "Asiatisches Ufer", strait: "Mitte der Meerenge", cta: "Bosporus-Sonnenuntergangsfahrt buchen", audioLang: "Sprache des Guides" },
  fr: { tap: "Touchez un site sur le détroit", lookFor: "Ce qu'il faut regarder", listen: "Écouter ce site", stop: "Arrêter l'audioguide", prev: "Précédent", next: "Suivant", europe: "Rive européenne", asia: "Rive asiatique", strait: "Milieu du détroit", cta: "Réserver la croisière au coucher du soleil", audioLang: "Langue du guide" },
  es: { tap: "Toca un lugar en el estrecho", lookFor: "Qué buscar", listen: "Escuchar este lugar", stop: "Detener la audioguía", prev: "Anterior", next: "Siguiente", europe: "Orilla europea", asia: "Orilla asiática", strait: "Centro del estrecho", cta: "Reservar el crucero al atardecer", audioLang: "Idioma de la guía" },
  ru: { tap: "Коснитесь объекта на проливе", lookFor: "На что смотреть", listen: "Прослушать этот объект", stop: "Остановить аудиогид", prev: "Назад", next: "Далее", europe: "Европейский берег", asia: "Азиатский берег", strait: "Середина пролива", cta: "Забронировать закатный круиз", audioLang: "Язык гида" },
  it: { tap: "Tocca un punto sullo stretto", lookFor: "Cosa cercare", listen: "Ascolta questo luogo", stop: "Ferma l'audioguida", prev: "Precedente", next: "Successivo", europe: "Sponda europea", asia: "Sponda asiatica", strait: "Centro dello stretto", cta: "Prenota la crociera al tramonto", audioLang: "Lingua della guida" },
  nl: { tap: "Tik op een plek op de zeestraat", lookFor: "Waar te kijken", listen: "Beluister deze plek", stop: "Audiogids stoppen", prev: "Vorige", next: "Volgende", europe: "Europese oever", asia: "Aziatische oever", strait: "Midden van de zeestraat", cta: "Boek de zonsondergangcruise", audioLang: "Taal van de gids" },
  ar: { tap: "اضغط على معلم على المضيق", lookFor: "ما الذي تبحث عنه", listen: "استمع إلى هذا المعلم", stop: "إيقاف الدليل الصوتي", prev: "السابق", next: "التالي", europe: "الضفة الأوروبية", asia: "الضفة الآسيوية", strait: "وسط المضيق", cta: "احجز رحلة الغروب", audioLang: "لغة الدليل" },
  ja: { tap: "海峡の名所をタップ", lookFor: "見どころ", listen: "この名所を聴く", stop: "音声ガイドを停止", prev: "前へ", next: "次へ", europe: "ヨーロッパ岸", asia: "アジア岸", strait: "海峡の中央", cta: "夕陽クルーズを予約", audioLang: "ガイドの言語" },
  zh: { tap: "点按海峡上的景点", lookFor: "看点", listen: "收听此景点", stop: "停止语音导览", prev: "上一个", next: "下一个", europe: "欧洲岸", asia: "亚洲岸", strait: "海峡中央", cta: "预订日落游船", audioLang: "导览语言" },
  pt: { tap: "Toque num ponto no estreito", lookFor: "O que observar", listen: "Ouvir este local", stop: "Parar o audioguia", prev: "Anterior", next: "Seguinte", europe: "Margem europeia", asia: "Margem asiática", strait: "Centro do estreito", cta: "Reservar o cruzeiro ao pôr do sol", audioLang: "Idioma do guia" },
};
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.05fr]">
        ...
        <div className="rounded-2xl border border-[var(--line)] bg-white p-4 md:p-5">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-b from-rose-50 to-sky-50" />
            <div className="absolute inset-y-0 left-1/2 w-[26%] -translate-x-1/2 bg-gradient-to-b from-sky-300/60 via-sky-400/60 to-sky-300/60" />
            <span className="absolute left-2 top-1/2 -rotate-90 text-[10px] font-bold uppercase tracking-[0.22em] text-rose-400">
              {ui.europe}
            </span>
            <span className="absolute right-2 top-1/2 rotate-90 text-[10px] font-bold uppercase tracking-[0.22em] text-sky-500">
              {ui.asia}
            </span>
                ...
                >
                  <span
                    className={`flex h-6 w-6 items-center justify-center rounded-full border-2 text-[10px] font-bold transition-all ${
                      isActive
                        ? "scale-125 border-white bg-[var(--brand-primary)] text-white shadow-lg"
                        : "border-white bg-white text-[var(--heading)] shadow hover:scale-110"
                    }`}
                  >
                    {i + 1}
                  </span>
