...
export default function BookingSidebar({
 ...
 // Pathname is the source of truth here since the booking sidebar is dropped
 // onto pages across both /en and localized routes.
 ...
 <a
 href={`${channel.url}?text=${quoteMessage}`}
 target="_blank"
 rel="noopener noreferrer"
 className="btn-cta flex w-full items-center justify-center"
 >
 {tour.enquiryLabel || t.planOnWhatsApp}
 </a>
 <a
 ...
 className="flex items-center justify-center gap-2 w-full py-2.5 rounded-full text-white font-semibold text-sm transition-all bg-[#25D366] hover:brightness-110"
 >
 <MessageCircle className="w-4 h-4" />
 {t.liveSupportWhatsApp}
 </a>
 <a
 ...
 className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full text-white shadow-sm bg-[#25D366]"
 aria-label={t.liveSupportWhatsApp}
 >
