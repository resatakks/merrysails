...
> = {
  ...
  de: {
    ...
    sunset: "Sonnenuntergangsfahrt ab €34 →",
  ...
  fr: {
    ...
    sunset: "Croisière coucher de soleil dès €34 →",
  ...
  nl: {
    ...
    sunset: "Zonsondergangscruise vanaf €34 →",
  ...
  it: {
    ...
    sunset: "Crociera al tramonto da €34 →",
  ...
  es: {
    ...
    sunset: "Crucero al atardecer desde €34 →",
  ...
  pt: {
    ...
    sunset: "Cruzeiro ao pôr do sol desde €34 →",
  ...
  hu: {
    ...
    sunset: "Naplemente hajóút €34-től →",
  ...
  el: {
    ...
    sunset: "Κρουαζιέρα ηλιοβασιλέματος από €34 →",
