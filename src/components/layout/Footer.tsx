      ...
      <div className="container-main py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2">
              <a href="tel:+905524638498" className="flex items-center gap-2 text-sm text-white/60 hover:text-[var(--brand-gold)] transition-colors">
                <Phone className="w-4 h-4 shrink-0" />
                +90 552 463 84 98
              </a>
              <a href="https://wa.me/905524638498" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-white/60 hover:text-[var(--brand-gold)] transition-colors">
                <Phone className="w-4 h-4 shrink-0" />
                WhatsApp
              </a>
              ...
              <div className="flex items-start gap-2 text-sm text-white/60">
                ...
                Arap Cami, Üsküfçüler Sk., 34445 Beyoğlu/Istanbul
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-white/40">
            © 2025 MerrySails — Merry Tourism. TURSAB Licensed. All rights reserved.
          </p>
