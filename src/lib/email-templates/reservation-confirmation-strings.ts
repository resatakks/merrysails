...
const en: ReservationEmailStrings = {
  ...
  children: (n) => `${n} child${n > 1 ? "ren" : ""} (3-8)`,
  infants: (n) => `${n} infant${n > 1 ? "s" : ""} (0-3)`,
  childDiscountLabel: "Child discount (ages 3-8 save 50%, ages 0-3 free)",
...
const tr: ReservationEmailStrings = {
  ...
  guest: (n) => `${n} misafir`,
  adults: (n) => `${n} yetişkin`,
  children: (n) => `${n} çocuk (3-8 yaş)`,
  infants: (n) => `${n} bebek (0-3 yaş)`,
  childDiscountLabel: "Çocuk indirimi (3-8 yaş %50, 0-3 yaş ücretsiz)",
...
const de: ReservationEmailStrings = {
  ...
  children: (n) => `${n} ${n === 1 ? "Kind" : "Kinder"} (3-8)`,
  infants: (n) => `${n} ${n === 1 ? "Kleinkind" : "Kleinkinder"} (0-3)`,
  childDiscountLabel: "Kinderrabatt (3-8 Jahre 50% Rabatt, 0-3 Jahre kostenlos)",
...
const fr: ReservationEmailStrings = {
  ...
  children: (n) => `${n} enfant${n > 1 ? "s" : ""} (3-8)`,
  infants: (n) => `${n} bébé${n > 1 ? "s" : ""} (0-3)`,
  childDiscountLabel:
    "Remise enfant (3-8 ans 50% de réduction, 0-3 ans gratuit)",
...
const nl: ReservationEmailStrings = {
  ...
  children: (n) => `${n} ${n === 1 ? "kind" : "kinderen"} (3-8)`,
  infants: (n) => `${n} ${n === 1 ? "baby" : "baby's"} (0-3)`,
  childDiscountLabel: "Kinderkorting (3-8 jaar 50% korting, 0-3 jaar gratis)",
...
const ru: ReservationEmailStrings = {
  ...
  adults: (n) => `${n} взр.`,
  children: (n) => `${n} реб. (3-8)`,
  infants: (n) => `${n} млад. (0-3)`,
  childDiscountLabel: "Детская скидка (3-8 лет скидка 50%, 0-3 года бесплатно)",
