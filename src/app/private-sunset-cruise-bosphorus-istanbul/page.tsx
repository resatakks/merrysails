...
const faqItems = [
  {
    ...
    "a": "The Boutique yacht is €220 for the whole yacht for two hours (up to 12 guests); the Premium yacht is €320 with a larger deck and snacks (up to 15 guests). Group yachts run €380 (Standard) to €500 (Signature); the 90-guest event yacht and 150-guest mega yacht are by quote. Every yacht is priced per boat, not per head, with 10% off from three hours."
  },
  {
