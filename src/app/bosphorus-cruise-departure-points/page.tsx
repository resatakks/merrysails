...
export const metadata: Metadata = {
 title: "Where Bosphorus Cruises Depart in Istanbul",
 description:
 "Where every Bosphorus cruise boards in Istanbul: Kabataş (dinner €30), Karaköy (sunset €34), Kuruçeşme (yacht). Exact piers, tram and taxi directions.",
 alternates: {
...
const faqItemsRu = [
 ...
 a: "Причал Кабаташ расположен у подножия дворца Долмабахче на европейском берегу. Добраться можно на трамвае T1 до остановки Kabataş или фуникулёром F1 от площади Таксим. Такси от Султанахмета — 10–15 минут. Точные координаты подтверждаются в WhatsApp после бронирования.",
 },
 {
 q: "Сколько стоят круизы с разных причалов?",
 a: "Закатный круиз от пирса Каракёй — от 34 EUR с человека (понедельник, вторник, четверг — от 30 EUR). Ужин-круиз с Кабаташа — от 30 EUR. Частная аренда яхты с Куручешме — от 200 EUR за яхту. Все туры — у оператора с лицензией TÜRSAB Группы А. Уточните цену в WhatsApp.",
 },
 {
 q: "Как добраться до пристани Куручешме (Kuruçeşme)?",
 a: "Куручешме Марина находится между Ортакёй и Арнавуткёй, около 7 км от Таксима. Прямого метро нет — рекомендуем такси (15–20 минут от центра) или паром по Босфору от Эминоню. Точное место швартовки сообщается в WhatsApp после подтверждения бронирования.",
 },
 {
 q: "Включён ли трансфер от отеля в стоимость круиза?",
 a: "Трансфер от отеля доступен для ужин-круиза из районов Султанахмет, Таксим, Сиркеджи и Каракёй. Гостей с трансфером доставляют к причалу Кабаташ. Для других туров трансфер можно добавить как опцию через WhatsApp. Услуги по лицензии TÜRSAB Группы А.",
 },
];
