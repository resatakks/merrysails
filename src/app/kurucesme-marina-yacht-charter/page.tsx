...
const faqItemsRu = [
 ...
 a: "Куручешме Марина расположена между Ортакёй и Арнавуткёй, около 7 км от площади Таксим. Прямого метро нет — добраться можно на такси (15–20 минут от центра) или на пароме по Босфору от Эминоню. Точное место швартовки сообщается в WhatsApp.",
 },
 {
 q: "Что включено в аренду яхты с Куручешме?",
 a: "В пакет включены: вся яхта только для вашей группы, капитан и команда, безалкогольные напитки, выбор маршрута, лицензия TÜRSAB Группы А. Опционально — ужин, алкоголь, торт, цветы, фотограф, скрипач. Связаться: WhatsApp.",
 },
 {
 q: "Можно ли организовать трансфер от отеля до Куручешме?",
 a: "Да, мы организуем трансфер от любого отеля в центре Стамбула (Султанахмет, Таксим, Бешикташ) до пирса Куручешме как опцию к аренде яхты. Время в пути — 15–25 минут. Уточнить условия и стоимость трансфера можно в WhatsApp.",
 },
];
...
export default function KurucesmeMarinaYachtCharterPage() {
 ...
 >Kurucesme Marina Yacht Charter Istanbul</span>
 </nav>
