...
const faqItemsRu = [
 ...
 a: "Ужин-круиз с турецким шоу начинается от 30 EUR с человека (пакет Silver Soft Drinks). Пакет Gold Unlimited Alcohol — 90 EUR с VIP-местами у сцены и неограниченным алкоголем. Все пакеты включают шоу с танцем живота. Оператор TÜRSAB Группы А. Уточните цену в WhatsApp.",
 },
 {
 q: "От какого причала отправляется ужин с турецким шоу?",
 a: "Ужин-круиз с турецким шоу отправляется с пирса Кабаташ (Kabataş) у дворца Долмабахче. Добраться можно трамваем T1 или фуникулёром F1 от Таксима. Прибыть рекомендуем за 15 минут. Точные координаты подтверждаются в WhatsApp.",
 },
 {
 q: "Что включено в программу турецкого шоу?",
 a: "В шоу включены: танец живота, фольклорные танцоры разных регионов Турции, живой DJ и интерактивные моменты с гостями. Дополнительно — мезе, основное блюдо, безалкогольные напитки (Silver) или открытый бар (Gold). Лицензия TÜRSAB Группы А. Подробности в WhatsApp.",
 },
 {
 q: "Подходит ли турецкое шоу для семьи или это формат только для взрослых?",
 a: "Турецкое шоу подходит для всей семьи — это культурное представление с танцем живота и фольклорными танцами без возрастных ограничений. Дети до 3 лет бесплатно, детям 3–13 лет скидка 50%. Уточните детские тарифы в WhatsApp.",
 },
];
...
export default function TurkishNightDinnerCruiseIstanbulPage() {
 ...
 >Turkish Night Dinner Cruise Istanbul</span>
 </nav>
