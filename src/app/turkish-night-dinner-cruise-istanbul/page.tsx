...
const faqItemsRu = [
 ...
 a: "Турецкое шоу подходит для всей семьи — это культурное представление с танцем живота и фольклорными танцами без возрастных ограничений. Дети до 6 лет бесплатно, скидки 30–50% на детей 6–12 лет. Уточните детские тарифы в WhatsApp.",
 },
];
