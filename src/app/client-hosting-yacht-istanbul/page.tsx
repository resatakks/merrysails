...
export const metadata: Metadata = {
  ...
  description:
    "Client hosting yacht Istanbul from EUR 220 per yacht. Private Bosphorus charter for companies focused on hospitality, guest experience, and invoice-ready planning.",
  alternates: {
      ...
      <main className="pt-28 pb-20 bg-[var(--surface-alt)]">
        <div className="container-main">
          ...
          >
            ...
            >Client Hosting Yacht Istanbul</span>
          </nav>
