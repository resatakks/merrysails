        ...
        <section className="mt-16 border-t border-[var(--line)] pt-10">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <p className="text-[var(--body-text)] leading-relaxed mb-4">
              ...
              ladder showing from EUR 30 (Mon, Tue & Thu) / EUR 34 for Without Wine and from EUR 35 (Mon, Tue & Thu) / EUR 40 for the wine-served option.
            </p>
