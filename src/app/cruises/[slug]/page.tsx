  ...
  const eventSchema =
    slug === "bosphorus-sunset-cruise"
      ? {
          ...
          eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode",
          eventStatus: "https://schema.org/EventScheduled",
          // 2026-06-06: upgraded to recurring Schedule array, modelled as
          // two seasonal windows because sunset shifts. Apr-Sep = 19:00,
          // Oct-Mar = 16:30. Full schema.org byDay URIs + duration so AI
          // engines can compute "today's departure" from the timestamp.
          eventSchedule: [
            {
              "@type": "Schedule",
              byDay: [
          ...
          location: {
            ...
            address: {
              "@type": "PostalAddress",
              streetAddress: "Karaköy ferry pier, next to Balıkçı Kemal",
