...
const faqItemsRu = [
 ...
 a: "Частные ужин-круизы отправляются с пирса Кабаташ (Kabataş) у дворца Долмабахче или с Куручешме Марины (Kuruçeşme) в зависимости от выбранной яхты. Точное место посадки подтверждается в WhatsApp после бронирования.",
 },
 {
 q: "Что включено в частный ужин-круиз?",
 a: "В пакет включены: вся яхта только для вашей группы, капитан и команда, сервированный ужин, безалкогольные напитки, маршрут по вашему выбору, лицензия TÜRSAB Группы А. Опционально — алкоголь, торт, цветы, фотограф, скрипач. Свяжитесь с нами в WhatsApp.",
 },
 {
 q: "Подходит ли частный ужин для романтического вечера или годовщины?",
 a: "Да, формат идеально подходит для пар, годовщин, помолвок и романтических ужинов. Вы получаете отдельный стол, выбираете маршрут (включая виды на дворец Долмабахче и Босфорский мост), время и атмосферу. Дополнительные опции (цветы, торт, музыка) — через WhatsApp.",
 },
];
