...
const faqItemsRu = [
 ...
 a: "Мы отправляемся с пирса Кабаташ (Kabataş) или Куручешме (Kuruçeşme), в зависимости от выбранной яхты. Фотограф встречает на пирсе или уже на борту — деталь согласовывается заранее. Точное место подтверждается в WhatsApp после бронирования.",
 },
 {
 q: "Что включено в пакет с фотографом?",
 a: "В пакет включены: частная яхта на 2 часа, капитан и команда, безалкогольные напитки, профессиональный фотограф, обработанные фото (обычно 30–80 кадров), лицензия TÜRSAB Группы А. Опционально — видеограф, торт, цветы, скрипач. Уточните в WhatsApp.",
 },
 {
 q: "Может ли фотограф оставаться незамеченным до момента предложения?",
 a: "Да, мы планируем съёмку так, чтобы фотограф оставался в стороне и не выдавал момент. Партнёр не должен заранее заподозрить съёмку — фотограф работает с длинных дистанций до самого момента. Согласовать сценарий можно в WhatsApp.",
 },
];
