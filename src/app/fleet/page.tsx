          ...
          {fleet.map((yacht, i) => (
            ...
            >
              ...
              <div className={i % 2 === 1 ? "lg:order-1" : ""}>
                <h2 className="font-heading text-3xl font-bold text-deep-navy">{yacht.name}</h2>
                <p className="text-gray-600 mt-4 leading-relaxed">{yacht.description}</p>

                <div className="flex gap-6 mt-6">
                  <div className="flex items-center gap-2">
                    <Users className="w-5 h-5 text-sunset" />
                    <span className="text-deep-navy font-semibold">{yacht.capacity} Kişi</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Ruler className="w-5 h-5 text-sunset" />
                    <span className="text-deep-navy font-semibold">{yacht.length}</span>
                  </div>
                </div>

                <div className="mt-6">
                  <h3 className="font-semibold text-deep-navy mb-3">Özellikler</h3>
                ...
                <div className="mt-6 flex items-center gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-deep-navy font-mono">
