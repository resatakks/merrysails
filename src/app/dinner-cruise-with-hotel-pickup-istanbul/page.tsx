...
const faqItemsRu = [
 ...
 a: "Ужин-круиз с трансфером начинается от 30 EUR с человека (пакет Silver Soft Drinks). В пакетах Gold (80–90 EUR) трансфер от отеля включён бесплатно. В Silver — трансфер доступен как опция. Оператор TÜRSAB Группы А. Уточните цену в WhatsApp.",
 },
 {
 q: "Из каких районов работает трансфер до пирса Кабаташ?",
 a: "Трансфер работает из центральных районов европейской стороны: Султанахмет, Таксим, Сиркеджи, Каракёй, Бешикташ. Все гости доставляются к пирсу Кабаташ (Kabataş) у дворца Долмабахче. Уточнить доступность для вашего отеля можно в WhatsApp.",
 },
 {
 q: "Что включено в ужин-круиз с трансфером?",
 a: "В пакет включены: трансфер от отеля и обратно, 3,5 часа на яхте, мезе, основное блюдо, безалкогольные напитки (Silver) или открытый бар (Gold), турецкое шоу с танцем живота, лицензия TÜRSAB Группы А. Подробности — в WhatsApp.",
 },
 {
 q: "Доступен ли трансфер для гостей с азиатской стороны Стамбула?",
 a: "Стандартный трансфер работает только для центральной европейской стороны. Гостям с азиатской стороны (Кадыкёй, Юскюдар) обычно рекомендуем самостоятельно добраться до Кабаташ или согласовать индивидуальный трансфер за доплату. Свяжитесь с нами в WhatsApp.",
 },
];
...
export default function DinnerCruiseWithHotelPickupIstanbulPage() {
 ...
 >Dinner Cruise with Hotel Pickup Istanbul</span>
 </nav>
