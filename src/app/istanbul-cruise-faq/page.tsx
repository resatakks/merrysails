...
}> = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "The cheapest live-guided Bosphorus cruise is the Sunset Cruise without wine from €30 per person (Mon, Tue & Thu) for 2 hours, or the Silver Soft Drinks dinner cruise at €30 per person for 3.5 hours including dinner and Turkish night show.",
      },
      {
