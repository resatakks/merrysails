...
const faqItemsRu = [
 ...
 a: "Романтические частные ужины обычно отправляются с пирса Кабаташ (Kabataş) у дворца Долмабахче или с Куручешме Марины (Kuruçeşme). Точное место посадки сообщается в WhatsApp после подтверждения бронирования.",
 },
 {
 q: "Что включено в частный ужин для двоих?",
 a: "В базовый пакет включены: вся яхта только для пары, капитан и команда, сервированный ужин на двоих, безалкогольные напитки, маршрут по Босфору. Опционально — шампанское, торт, букет, скрипач, фотограф. Все услуги по лицензии TÜRSAB Группы А. Связаться: WhatsApp.",
 },
 {
 q: "Подходит ли этот формат для годовщины или медового месяца?",
 a: "Да, формат идеально подходит для годовщин, свадебных путешествий и романтических вечеров. Вы получаете только свою яхту, отдельный стол с видом на огни Босфорского моста и индивидуальный маршрут. Дополнения (цветы, торт, музыка) — через WhatsApp.",
 },
];
