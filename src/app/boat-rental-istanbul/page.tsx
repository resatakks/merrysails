...
const faqSchema = {
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Стоимость аренды лодки начинается от 200 EUR за яхту за 2 часа. Финальная цена зависит от размера судна, маршрута, длительности и дополнительных опций (ужин, торт, цветы). Все цены — у лицензированного оператора TÜRSAB Группы А. Уточните стоимость в WhatsApp.",
 },
 },
 {
 "@type": "Question",
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Частные лодки обычно отправляются с пирсов Куручешме (Kuruçeşme), Кабаташ (Kabataş) или Бебек (Bebek) на европейской стороне Босфора. Точный пирс посадки подтверждается после выбора яхты через WhatsApp.",
 },
 },
 {
 "@type": "Question",
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "В базовый пакет включены: частное судно с капитаном и командой, безалкогольные напитки, лицензия TÜRSAB Группы А и страхование. Опционально — ужин, алкоголь, торт, цветы, музыка, фотограф. Полный список услуг — в WhatsApp.",
 },
 },
 {
 "@type": "Question",
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "Да, у нас есть лодки разной вместимости — от компактных яхт для пар до больших судов до 20 гостей. Вы можете выбрать формат: маленькая частная яхта, праздничная лодка или большое судно для группы. Свяжитесь с нами через WhatsApp для подбора.",
 },
 },
 ],
};
