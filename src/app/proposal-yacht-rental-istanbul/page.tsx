...
const faqItemsRu = [
 ...
 a: "Мы отправляемся с пирса Кабаташ (Kabataş) или Куручешме (Kuruçeşme), в зависимости от выбранной яхты. Точный пирс посадки подтверждается в WhatsApp после бронирования.",
 },
 {
 q: "Что включено в пакет для предложения руки и сердца?",
 a: "В пакет включены: частная яхта на 2 часа, капитан и команда, безалкогольные напитки, лицензия TÜRSAB Группы А. Дополнительно можно заказать букет, торт, фотографа, видеографа и скрипача через WhatsApp.",
 },
 {
 q: "Подходит ли яхта для предложения руки и сердца на закате?",
 a: "Да, мы рекомендуем именно закатный тайминг — мягкий свет и виды на первый Босфорский мост создают идеальный фон. Время посадки рассчитываем индивидуально под закат. Свяжитесь с нами через WhatsApp для согласования времени.",
 },
];
