...
const CONTENT: Record<string, LocaleContent> = {
  ...
  ru: {
    ...
    capsule:
      "Свадебное путешествие на яхте по Босфору даёт молодожёнам частную яхту на 2-3 часа от €280. Встреча с шампанским, индивидуальный торт с датой вашей свадьбы, профессиональный фотограф (50+ обработанных фото за 7 дней), живой скрипач и тайминг заката — по запросу. Отправление от Кабаташ или марины Куручешме; точный причал подтверждается по Telegram/WhatsApp после бронирования. Идеально для последнего вечера в Стамбуле перед перелётом в Каппадокию или Анталию.",
    ...
    ctaWhatsapp: "Отправить бриф медового месяца через Telegram",
