...
const CONTENT: Record<string, LocaleContent> = {
  ...
  ru: {
    metaTitle: "Аренда яхты для предложения руки в Стамбуле",
    metaDescription:
      "Частное предложение руки на яхте в Стамбуле. Романтический сюрприз на Босфоре в час заката с цветами, фотографом, скрипачом и оформлением.",
    canonicalPath: "/ru/proposal-yacht-rental-istanbul",
    breadcrumbHome: "Главная",
    breadcrumbCruise: "Круиз по Босфору",
    breadcrumbCurrent: "Предложение руки на яхте",
    eyebrow: "Предложение руки на яхте",
    heroTitle: "Предложение руки и сердца на яхте в Стамбуле",
    heroSubtitle: "Романтический сюрприз на Босфоре, построенный вокруг момента предложения.",
    heroDescription:
      "Полностью частная яхта на Босфоре только для пары, где всё подстроено под предложение. Конфиденциальность, тайминг заката и оформление планируются вокруг самого момента.",
    whyHeading: "Почему это правильный выбор для предложения",
    reasons: [
      {
        title: "Яхта только для пары",
        desc: "Других гостей на борту нет — вся яхта остаётся приватной до момента предложения, чтобы сюрприз сохранился полностью.",
      },
      {
        title: "Закат или огни мостов",
        desc: "Мягкий закатный свет в районе Ортакёй и первого Босфорского моста, или тихая бухта под огнями мостов вечером.",
      },
      {
        title: "Готовое оформление под предложение",
        desc: "Цветы, оформление, фотограф, скрипач и торт — всё готовится вокруг предложения, чтобы вам осталось только услышать «да».",
      },
    ],
    addOnsHeading: "Доступные дополнительные опции",
    addOns: [
      "Цветы и букет",
      "Оформление для предложения (свечи, лепестки роз, гирлянды)",
    ...
    faqs: [
      {
        question: "Чем отличается от обычной аренды яхты?",
        answer:
          "Бронирование строится прежде всего вокруг момента предложения — конфиденциальность, тайминг маршрута и оформление настраиваются под предложение, а не под обычную прогулку.",
      },
      {
        question: "Сколько это стоит?",
        answer:
          "Стоимость зависит от типа яхты, времени, уровня приватности и выбранных дополнений — таких как оформление и фотограф.",
      },
      {
        question: "Можно ли организовать цветы, фотографа и скрипача?",
        answer:
          "Да. Оформление для предложения, букет, фотограф, видеограф, скрипач, торт и ужин могут быть организованы.",
      },
      {
        question: "Какой маршрут подходит для предложения?",
        answer:
          "Предложения на закате хорошо работают в районе Ортакёй и первого Босфорского моста; вечерние предложения лучше подходят к тихим бухтам под огнями мостов.",
      },
      {
        question: "Насколько заранее нужно бронировать?",
        answer:
          "В высокий сезон и в выходные мы рекомендуем бронировать минимум за 1-2 недели; оформление и фотограф требуют времени на подготовку.",
      },
    ],
    tableHeading: "Краткий обзор",
    tableRows: [
      { label: "Уровень приватности", value: "Полностью приватно — на борту нет других гостей" },
      { label: "Маршрут", value: "Ортакёй и первый мост на закате или огни мостов вечером" },
      { label: "Обычная длительность", value: "1,5-3 часа (короткое предложение или с ужином)" },
      { label: "Доступные пакеты", value: "Цветы, фотограф, скрипач, торт, оформление, ужин" },
    ],
    ctaHeading: "Давайте вместе спланируем предложение",
    ctaBody:
      "Отправьте нам дату, желаемое время и уровень оформления — мы предложим варианты яхт, подходящие под ваш план предложения.",
    ctaWhatsapp: "Спланировать в WhatsApp",
    ctaCall: "Позвонить",
...
export async function generateStaticParams() {
  return [{ locale: "tr" }, { locale: "de" }, { locale: "fr" }, { locale: "nl" }, { locale: "ru" }];
}
