...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Тур на Принцевы острова из Стамбула 2026 — общий день €45 (паром + гид + обед) или частная яхта от €220. Бююкада, Хейбелиада, острова без машин.",
    alternates: { canonical: canonicalUrl, languages: undefined },
    openGraph: {
      title: "Принцевы острова Стамбул — от €45",
      description: "Два способа посетить Принцевы острова из Стамбула: общий 8-часовой паромный тур €45 или частная яхта от €220.",
...
const FAQ_ITEMS = [
  ...
  { q: "Есть ли частная яхта из Стамбула на Принцевы острова?", a: "Да — MerrySails предлагает частные дневные чартеры из марины Кёручешме или Кабаташ. Типичный день яхты на Принцевых островах — 6-8 часов от €220 до 12 гостей (яхта Boutique), с остановками на Бююкаде, Хейбелиаде и в Вашей бухте для купания. Большие яхты для групп до 150 человек." },
];

const pageSchema = {
  "@context": "https://schema.org", "@type": "TouristAttraction",
  name: "Тур на Принцевы острова из Стамбула",
  description: "Два способа посетить Принцевы острова из Стамбула: общий гид-тур на пароме €45 или частная яхта от €220. Бююкада, Хейбелиада, Бургазада и Кыналыада — архипелаг без машин в Стамбуле.",
      ...
      <section className="border-b border-[var(--line)] bg-gradient-to-b from-[var(--accent-soft,#f5f0e6)] to-[var(--bg)]">
        <div className="mx-auto max-w-5xl px-4 py-10 sm:py-14">
          ...
          <p className="text-base sm:text-lg text-[var(--body-text)] max-w-3xl">
            <strong>Кратко.</strong> Два способа посетить безмашинные Принцевы острова Стамбула: общий тур на пароме за <strong>€45/чел.</strong> (8 часов, обед + гид) или частная яхта от <strong>€220</strong> до 12 гостей (гибкий день 6-8 часов, Вы выбираете острова и бухты). Четыре обитаемых острова — Бююкада, Хейбелиада, Бургазада, Кыналыада — без частных машин, только велосипеды, электрические шаттлы и пешеходные дорожки.
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            <Link href="/ru/yacht-charter-istanbul" className="inline-flex items-center gap-2 rounded-full border border-[var(--brand)] px-5 py-3 text-sm font-semibold text-[var(--brand)] hover:bg-[var(--brand)]/5 transition">Частная яхта от €220 <ArrowRight className="w-4 h-4" /></Link>
      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border border-[var(--brand)]/30 bg-[var(--brand)]/5 p-5">
            ...
            <h3 className="text-xl font-bold text-[var(--heading)] mb-2">От €220 / яхта</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex gap-2"><Users className="w-4 h-4 mt-0.5 text-[var(--text-muted)]" /><span>2-150 гостей (Boutique до 12)</span></li>
