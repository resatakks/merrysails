...
const TRANSLATIONS: Record<string, LocaleContent> = {
  tr: {
    metaTitle: "İstanbul Ürün Lansmanı Yat | Boğaz'da Özel",
    metaDescription:
  ...
  de: {
    metaTitle: "Produktlaunch Yacht Istanbul — Bosporus Event",
    metaDescription:
  ...
  fr: {
    metaTitle: "Lancement de Produit sur Yacht Istanbul",
    metaDescription:
  ...
  nl: {
    metaTitle: "Productlancering Jacht Istanbul — Bosporus",
    metaDescription:
