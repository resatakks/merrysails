...
const CONTENT: Record<string, LocaleContent> = {
  tr: {
    metaTitle: "Kabataş Akşam Yemeği Turu €30'dan | Boğaz",
    metaDescription:
  ...
  de: {
    metaTitle: "Kabataş Dinner-Kreuzfahrt Istanbul ab €30",
    metaDescription:
  ...
  fr: {
    metaTitle: "Croisière Dîner Kabataş Istanbul dès €30",
    metaDescription:
  ...
  nl: {
    metaTitle: "Kabataş Dinercruise Istanbul vanaf €30",
    metaDescription:
  ...
  ru: {
    metaTitle: "Круиз с ужином от Кабаташ Стамбул от €30",
    metaDescription:
      "Круиз с ужином от Кабаташ в Стамбуле: пакеты от €30, турецкая вечерняя программа, вид на дворец Долмабахче. Сертификация TÜRSAB. Забронировать.",
    canonicalPath: "/ru/kabatas-dinner-cruise-istanbul",
    breadcrumbHome: "Главная",
    breadcrumbDinner: "Круиз с ужином",
    breadcrumbCurrent: "Отправление от Кабаташ",
    eyebrow: "MerrySails Стамбул — Пирс Кабаташ",
    heroTitle: "Круиз с ужином от Кабаташ Стамбул",
    heroSubtitle: "От €30 на человека · Отправление перед дворцом Долмабахче",
    heroDescription:
      "Круиз с ужином от Кабаташ отправляется из самой оживлённой точки Босфора — прямо перед дворцом Долмабахче. До пирса легко добраться на метро и трамвае, и он считается самым популярным местом отправления круизов с ужином по Босфору в Стамбуле. С турецкой вечерней программой, ужином и маршрутом 3,5 часа мы предлагаем пакеты от €30. С 2001 года мы приняли более 50 000 гостей.",
    trustSignal: "Сертификат TÜRSAB категории A — Merry Tourism Стамбул с 2001 года, 50 000+ гостей",
    keyFacts: [
      { icon: "⏱", label: "Длительность", value: "около 3,5 часов" },
      { icon: "📍", label: "Отправление", value: "Пирс Кабаташ, 20:30" },
      { icon: "💶", label: "Цена", value: "От €30 на человека" },
      { icon: "🎭", label: "В пакете", value: "Турецкое шоу + ужин" },
    ],
    sections: [
      {
        heading: "Пирс Кабаташ: ворота Стамбула на Босфор",
        body: [
          "Пирс Кабаташ расположен прямо рядом с дворцом Долмабахче, в стратегической точке, где Босфор сливается с заливом Золотой Рог. Это расположение позволяет судам сразу выходить к лучшим панорамам Босфора: уже вскоре после отправления становятся видны дворец Чыраган, мечеть Ортакёй и силуэты Босфорских мостов.",
          "Пирс хорошо доступен из всех районов Стамбула. От Таксима по линии метро M2 — всего 5 минут; от Эминёню до Кабаташ примерно 20 минут на трамвае T1. От Султанахмета, Бейоглу или Бешикташа удобно доехать и на такси.",
          "Вечером вокруг пирса царит оживлённая атмосфера. Подсветка дворца Долмабахче и закатные цвета над Босфором создают незабываемые впечатления ещё до отправления.",
        ],
      },
      {
        heading: "Почему выбрать круиз с ужином от Кабаташ?",
        body: [
          "Круиз с ужином от Кабаташ особенно удобен для гостей, проживающих в отелях Таксима, Бешикташа, Нишанташи или поблизости Кабаташ. Вместо проезда через плотный трафик европейского берега вы добираетесь до пирса на общественном транспорте.",
          "Точка отправления имеет и навигационные преимущества: судно сразу выходит на открытую воду без сложных портовых манёвров. Благодаря этому большую часть круиза вы проводите с беспрепятственным видом на Босфор.",
          "Наш отельный шаттл-сервис охватывает большинство отелей рядом с Кабаташ и в центральных кварталах европейского берега. Время выезда сообщается письменно в подтверждении бронирования.",
        ],
      },
      {
        heading: "Меню ужина и турецкая вечерняя программа",
        body: [
          "Каждый пакет круиза с ужином включает одинаковую развлекательную программу: живую турецкую музыку, фольклорные танцы, выступление давул-зурна и интерактивные танцы. В зависимости от пакета подаётся обслуживание за столом или вечерний буфет.",
          "Меню предлагает классику турецкой кухни: оливковые закуски, далее гриль из мяса (курица, ягнёнок, кёфте), рис и турецкие десерты. Доступны вегетарианские варианты; безглютеновые корректировки готовятся по запросу.",
          "Гости пакета Gold размещаются на VIP-местах рядом со сценой, получают премиум-меню, безлимитные напитки и DJ-сет. Пакет Silver включает стандартное место, стандартное меню и турецкую вечернюю программу.",
        ],
      },
      {
      ...
      {
        heading: "Как добраться до пирса Кабаташ",
        body: [
          "Несколько вариантов общественного транспорта делают пирс Кабаташ доступным из всех частей Стамбула. Самый быстрый маршрут — метро M2 от Таксима: всего одна остановка, около 5 минут.",
          "Трамвай T1 отправляется из Эминёню, Гранд-базара и Беязыта, конечная — Кабаташ. Идеальный вариант из Султанахмета, около 20 минут в пути. Оплата картой Istanbulkart или разовым билетом.",
          "Для тех, кто едет на такси: от Таксима около 10 минут, от Султанахмета 15-20 минут. Учитывайте вечерний трафик. Рекомендуем приезжать на пирс минимум за 20 минут до отправления.",
        ],
      },
      {
        heading: "Безопасность, сертификация и бронирование",
        body: [
          "MerrySails работает под Merry Tourism, имеющей сертификат TÜRSAB категории A в Стамбуле с 2001 года. Все наши круизы соответствуют турецкому морскому регулированию; экипаж опытный и сертифицированный.",
          "Бронирования бесплатно отменяются за 48 часов до отправления. В высокий сезон (с мая по сентябрь) рекомендуем бронировать минимум за 3-5 дней, так как круизы часто заполнены.",
          "Все детали пакетов, информация о маршруте и отзывы гостей доступны на нашей основной странице круиза с ужином в Стамбуле. Наш WhatsApp работает 24/7 для ваших вопросов.",
        ],
      },
    ],
    packagesHeading: "Варианты пакетов",
    ...
    packages: [
      {
        ...
        price: "€30",
        highlight: false,
        items: ["Стандартное место", "Безлимитные безалкогольные напитки", "Меню ужина", "Турецкая вечерняя программа"],
      },
      {
        name: "Silver Alcoholic",
        price: "€45",
    ...
    transportHeading: "Как добраться",
    transportIntro: "Так вы доберётесь до пирса Кабаташ:",
    transportItems: [
      { mode: "Метро M2", detail: "От Таксима — всего 5 минут, 1 остановка" },
      { mode: "Трамвай T1", detail: "От Эминёню / Султанахмета — около 20 минут" },
      { mode: "Автобус", detail: "Линии через Бешикташ и Кадыкёй" },
      { mode: "Такси", detail: "От Таксима ~10 мин, от Султанахмета ~15 мин" },
    ],
    faqHeading: "Часто задаваемые вопросы",
    faqs: [
      {
        q: "Во сколько отправляется круиз с ужином от Кабаташ?",
        a: "Отправление в 20:30. Будьте на пирсе минимум за 20 минут для регистрации. Точное время посадки указано в подтверждении бронирования.",
      },
      {
        q: "Как добраться до пирса Кабаташ?",
        a: "От Таксима на метро M2 за 5 минут, от Султанахмета на трамвае T1 примерно за 20 минут. На такси около 10-15 минут от центра.",
      },
      {
        q: "Доступен ли отельный шаттл?",
        a: "Да, для выбранных отелей центральных районов европейского берега доступен шаттл. Выберите эту опцию при бронировании; время выезда вы получите в письменном виде.",
      },
      {
      ...
      },
      {
        ...
        a: "Да, вегетарианские блюда доступны. Для безглютеновых корректировок просим указать это при бронировании, чтобы мы могли подготовить заранее.",
      },
      {
        q: "Когда начинается шоу?",
        a: "Программа шоу начинается примерно через 30-45 минут после отправления. Она включает фольклорные танцы, живую музыку, давул-зурна и интерактивные танцевальные шоу.",
      },
      {
      ...
      },
      {
        ...
        a: "Бесплатная отмена за 48 часов до отправления. В случае плохой погоды круиз переносится или возвращается оплата.",
      },
    ],
    relatedHeading: "Другие варианты",
    ctaHeading: "Забронировать круиз с ужином от Кабаташ",
    ctaSubtitle: "Укажите дату и число человек — гарантируем быстрый ответ.",
    bookLabel: "Забронировать сейчас",
    whatsappLabel: "Написать в WhatsApp",
    mainPageNote:
      "Все детали пакетов, фотографии и отзывы вы найдёте на",
  },
};
...
const RELATED_LINKS: Record<string, { href: string; title: string; desc: string }[]> = {
  ...
  ru: [
    { href: "/istanbul-dinner-cruise", title: "Круиз с ужином в Стамбуле", desc: "Основная страница — все пакеты и цены" },
    { href: "/cruises/bosphorus-sunset-cruise", title: "Круиз на закате", desc: "Круиз 2 часа от €30 (вт и чт)" },
    { href: "/private-bosphorus-dinner-cruise", title: "Частный круиз с ужином", desc: "Эксклюзивная яхта только для вашей группы" },
  ],
};
