...
const TRANSLATIONS: Record<string, LocaleContent> = {
  tr: {
    metaTitle: "Özel Tekne Etkinliği İstanbul | Kutlama Yatı",
    metaDescription:
  ...
  de: {
    metaTitle: "Private Bootsparty Istanbul | Geburtstag Jacht",
    metaDescription:
  ...
  fr: {
    metaTitle: "Fête Privée en Yacht Istanbul | Anniversaire",
    metaDescription:
  ...
  nl: {
    metaTitle: "Privéfeestje op Jacht Istanbul | Verjaardag",
    metaDescription:
  ...
  ru: {
    metaTitle: "Частный праздник на яхте Стамбул",
    metaDescription:
      "Тур на день рождения, юбилей, девичник и частные праздники на Босфоре. Частная яхта с тортом, оформлением, фотографом и DJ.",
    canonicalPath: "/ru/private-events",
    breadcrumbHome: "Главная",
    breadcrumbCurrent: "Частные мероприятия",
    heroTitle: "Частный праздник на яхте в Стамбуле",
    heroSubtitle:
      "Дни рождения, юбилеи и частные праздники на Босфоре на частной яхте",
    heroDescription:
      "MerrySails организует частные праздники: дни рождения, юбилеи, девичники, baby shower и частные ужины. Вся яхта эксклюзивно для вашей компании; торт, оформление, фотограф, DJ или живая музыка и кейтеринг добавляются под ваш праздник.",
    whyHeading: "Почему MerrySails для вашего частного праздника?",
    reasons: [
      {
        title: "Вся яхта для вашей компании",
        desc: "Без общих круизов: яхта только для вашей группы. Вы определяете время, маршрут и музыку.",
      },
      {
        title: "Полностью подстроено под ваш праздник",
        desc: "Торт, шары, цветы, персональное оформление, фотограф, DJ или живая музыка — всё подстраиваем под вашу тему. Сюрпризы тоже планируем вместе.",
      },
      {
        title: "Подходит для малых и средних групп",
        desc: "Идеально для дней рождения, baby shower, девичников и частных ужинов — уютно и по-домашнему.",
      },
    ],
    formatsHeading: "Форматы частных праздников",
    formats: [
      {
        title: "Тур на день рождения",
        desc: "Достаточно места для торта, музыки и фотографий; собственный сценарий и моменты сюрприза легко планируются.",
      },
      {
        title: "Юбилей / годовщина свадьбы",
        desc: "Романтически вдвоём или большой компанией с семьёй — выстраиваем вечер вокруг празднования.",
      },
      {
        title: "Семейные и праздничные вечера",
        desc: "Удобно для семьи, безопасно для детей. Тема, кейтеринг и фоторепортаж — опционально.",
      },
      {
        title: "Девичник / baby shower",
        desc: "Частный праздник для небольшой компании подруг — с оформлением, музыкой и фотографом по желанию.",
      },
    ],
    faqHeading: "Часто задаваемые вопросы",
    faqs: [
      {
        q: "Как формируется цена частного праздника на яхте?",
        a: "Цена зависит от числа гостей, длительности, типа судна, пожеланий по кейтерингу и дополнений вроде оформления, музыки или фотографии. Все запросы рассчитываются по смете.",
      },
      {
        q: "Организуете ли вы торт, оформление, фотографа и музыку?",
        a: "Да. Торт, оформление шарами и цветами, профессиональный фотограф, DJ или живая музыка могут быть частью организации.",
      },
      {
        q: "Какие поводы подходят для этой страницы?",
        a: "Дни рождения, юбилеи, baby shower, девичники и гибкие частные праздники. Для предложений руки и сердца у нас отдельная страница.",
      },
      {
        q: "Можно ли добавить еду и напитки?",
        a: "Да. Фиксированное меню, фуршет, hapjes-сервис или индивидуальное меню от приватного шефа возможны; пакеты напитков (с алкоголем или без) формируются отдельно.",
      },
    ],
