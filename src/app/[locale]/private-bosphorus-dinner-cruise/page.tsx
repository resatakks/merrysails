...
const TRANSLATIONS: Record<string, LocaleContent> = {
  tr: {
    metaTitle: "Boğaz'da Özel Akşam Yemeği Turu İstanbul",
    metaDescription:
  ...
  de: {
    metaTitle: "Privates Bosporus-Dinner auf der Yacht Istanbul",
    metaDescription:
  ...
  fr: {
    metaTitle: "Dîner Privé en Yacht sur le Bosphore Istanbul",
    metaDescription:
  ...
  nl: {
    metaTitle: "Privédiner op Jacht Bosporus Istanbul",
    metaDescription:
  ...
  ru: {
    metaTitle: "Частный ужин на яхте Босфор Стамбул",
    metaDescription:
      "Частный ужин на собственной яхте на Босфоре: приватный стол, гибкий маршрут, закат или вечер. Идеально для предложения руки, годовщины и дня рождения.",
    canonicalPath: "/ru/private-bosphorus-dinner-cruise",
    breadcrumbHome: "Главная",
    breadcrumbCruise: "Круиз по Босфору",
    breadcrumbCurrent: "Частный ужин на Босфоре",
    eyebrow: "MerrySails Стамбул",
    heroTitle: "Частный ужин на яхте на Босфоре",
    heroSubtitle: "Ваша яхта, ваш стол",
    heroDescription:
      "Частный ужин на яхте на Босфоре для пар, небольших групп, предложений руки, годовщин и дней рождения. Яхта, стол и время полностью ваши, а маршрут мы подстраиваем под ваш вечер.",
    whyHeading: "Почему именно частный, а не общий круиз с ужином?",
    reasons: [
      {
        title: "Яхта полностью ваша",
        desc: "Без общих столов и без шоу турецкой ночи. Только ваша группа, ваш стол и спокойный вечер на воде.",
      },
      {
        title: "Гибкое время и маршрут",
        desc: "Хотите отправиться в час золотого света или когда город уже подсвечен? Время отправления, остановки и продолжительность настраиваются под ваше пожелание.",
      },
      {
        title: "Идеально для особых моментов",
        desc: "Предложение руки, годовщина, день рождения или маленький семейный ужин — цветы, торт, фотограф и оформление стола готовятся на борту.",
      },
    ],
    faqHeading: "Часто задаваемые вопросы",
    faqs: [
      {
        question: "Чем отличается от общего круиза с ужином?",
        answer:
          "Яхта зарезервирована исключительно для вашей группы. Ужин, тайминг и атмосфера на борту строятся вокруг вашего стола, а не вокруг общего рассадочного плана.",
      },
      {
        question: "На какое количество гостей подходит?",
        answer:
          "Лучше всего для пар и небольших групп от 2 до 10 человек. Правильная яхта зависит от числа гостей, расстановки стола и желаемого пространства на палубе.",
      },
      {
        question: "Можно ли организовать предложение руки или день рождения?",
        answer:
          "Да. Цветы, торт, фотограф, скрипач и оформление стола могут быть организованы на борту. Все детали мы подтверждаем письменно до бронирования.",
      },
      {
        question: "Может ли ужин быть скромнее?",
        answer:
          "Да. Если вам нужен только приватный стол, чёткий маршрут и спокойный вечер на воде, мы намеренно держим формат сдержанным.",
      },
    ],
    ...
    compareHeading: "Сравните перед бронированием",
    ctaHeading: "Запросите цену частной яхты с ужином",
    ctaBody:
      "Отправьте нам дату, число гостей и повод — мы предложим подходящие яхты и варианты меню.",
...
> = {
  ...
  ru: [
    {
      href: "/istanbul-dinner-cruise",
      title: "Общий круиз с ужином",
      description: "Фиксированные пакеты на общем судне с турецкой вечерней программой.",
    },
    {
      href: "/yacht-charter-istanbul",
    ...
    {
      href: "/boat-rental-istanbul",
      title: "Аренда лодки в Стамбуле",
      description: "Сначала приватная лодка, потом ужин и программу собираете сами.",
    },
  ],
};
