...
const TRANSLATIONS: Record<string, LocaleContent> = {
  ...
  ru: {
    metaTitle: "Аренда яхты от Куручешме Марина Стамбул",
    metaDescription:
      "Частная аренда яхты от Куручешме Марина: тур по Босфору, посадка, доступ к марине и детали частной аренды. Смета на основе даты и группы.",
    canonicalPath: "/ru/kurucesme-marina-yacht-charter",
    breadcrumbHome: "Главная",
    breadcrumbCurrent: "Куручешме Марина — аренда яхты",
    heroBadge: "Страница поддержки бронирования от марины",
    heroTitle: "Аренда яхты от Куручешме Марина, Стамбул",
    heroSubtitle:
      "Точка отправления, посадка и логистика прибытия для частной яхты на Босфоре",
    heroDescription:
      "Эта страница для гостей, которые уже знают, что частная яхта — правильный выбор, и хотят конкретной ясности по отправлению от Куручешме Марина. Основная страница показывает пакеты и цены; эта страница фокусируется на марине, тайминге посадки и контексте пирса, подстроенном под вашу дату и группу.",
    trustHeading: "Поддержка по отправлению",
    trustBody:
      "MerrySails работает под Merry Tourism — стамбульский оператор с лицензией TÜRSAB с 2001 года. Куручешме Марина — практическая опорная точка для частных отправлений; точное место посадки фиксируется в письменном подтверждении бронирования.",
    ctaCompare: "Сравнить пакеты яхт",
    ctaContact: "Уточнить пригодность марины",
    asideHeading: "Что помогает нам уточнить отправление",
    asideItems: [
      "Предпочтительная дата и ориентировочное время аренды",
      "Число гостей и тип (простая аренда или event)",
      "Потребность в трансфере или самостоятельное прибытие",
      "Является ли предложение руки, ужин или праздник частью брифа",
    ],
    reasonsHeading: "Почему гости выбирают Куручешме Марина",
    reasons: [
      {
        title: "Чёткая частная посадка",
        desc: "Подходит для групп, которые хотят спокойного прибытия в марину без сложной event-инфраструктуры вокруг.",
      },
      {
        title: "Отправление под закат или фото-тайминг",
        desc: "Удобно, когда марина и слот отправления должны совпадать со светом, маршрутом или короткой люкс-прогулкой.",
      },
      {
        title: "Логистика для последующих дополнений",
        desc: "Полезно, если яхта и посадка должны быть подтверждены до того, как обсуждать оформление или кейтеринг.",
      },
    ],
    flowHeading: "Как обычно проходит марино-ориентированное бронирование",
    flow: [
      {
        title: "Подтвердите частную аренду яхты как основной маршрут",
        desc: "Основная страница покрывает сравнение пакетов. Эта страница актуальна, когда частная аренда уже выбрана.",
      },
      {
        title: "Используйте Куручешме как практическую точку отправления",
        desc: "Для многих частных отправлений Куручешме — самая чистая публичная опорная точка, но автоматически она не гарантируется.",
      },
      {
        title: "Трансфер или самостоятельное прибытие",
        desc: "Некоторые бронирования — простая самостоятельная аренда; другие требуют отельного трансфера или event-прибытия.",
      },
      {
        title: "Письменное подтверждение — источник истины",
        desc: "Марина, время и посадка на вашу дату фиксируются только в финальном письменном подтверждении.",
      },
    ],
    faqHeading: "Часто задаваемые вопросы",
    faqs: [
      {
        q: "Все ли частные яхты отправляются от Куручешме Марина?",
        a: "Многие частные аренды используют Куручешме как самую ясную опорную точку; точное место посадки зависит от яхты, маршрута и бронирования.",
      },
      {
        q: "Это основная страница частной аренды яхты в Стамбуле?",
        a: "Нет. Основная страница — Yacht Charter Istanbul. Эта страница поддержки только проясняет вопросы марины и посадки, когда частная аренда уже выбрана.",
      },
      {
        q: "Нужно ли мне открывать другую страницу, если речь именно о предложении руки или ужине?",
        a: "Да. Для предложения руки подходит страница proposal; для частного ужина — страница private dinner.",
      },
      {
        q: "Что помогает команде подтвердить правильный поток марины?",
        a: "Дата, число гостей, бриф по яхте, потребность в трансфере и уровень события — главные пункты.",
      },
    ],
    finalHeading: "Отправьте бриф, мы подтвердим самый чистый маршрут отправления",
    finalBody:
      "Укажите дату, размер группы и хотите ли вы простую частную аренду или более event-ориентированную структуру. Мы укажем правильный поток марины и аренды.",
