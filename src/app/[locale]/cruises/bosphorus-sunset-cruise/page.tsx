  ...
  ru: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Отправление от пирса Карайёй (европейская сторона), рядом с памятником Мимару Синану — в нескольких минутах ходьбы от Галатского моста и Кабаташа. Точная точка встречи и время высылаются Вам письменно через Telegram (@merrysails) после подтверждения бронирования.",
      },
      {
