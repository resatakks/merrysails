...
const TRANSLATIONS: Record<string, LocaleContent> = {
  ...
  ru: {
    ...
    trustSignal:
      "Merry Tourism — лицензированное агентство группы А TÜRSAB (лицензия №14316) с 2001 года, обслужившее более 50 000 гостей. Точка отправления находится в районе Кабаташ; точный адрес высылается после подтверждения бронирования.",
    tableRows: [
      ["Длительность", "≈ 2 часа"],
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Отправление из района Кабаташ на европейской стороне. Точная точка встречи и время высылаются Вам письменно после подтверждения бронирования.",
      },
      {
      ...
      },
      {
        ...
        a: "Удобнее всего написать нам в Telegram (@merrysails) — отвечаем на русском, бронирование подтверждается за несколько минут в рабочее время. Также доступен телефон +90 544 898 98 12. Мы намеренно используем Telegram как основной канал для гостей из России.",
      },
    ],
    ...
    ctaWhatsappLabel: "Написать в Telegram",
  },
};
