...
const CONTENT: Record<string, LocaleContent> = {
  tr: {
    ...
    metaDescription:
      "Çocuklu aileler için Boğaz turu — otel transferi dahil, 3 yaş altı ücretsiz, 4-10 yaş çocuk fiyatı, 24 saat ücretsiz iptal. €30/kişi'den, TÜRSAB lisanslı.",
    ...
    intro:
      "4 kişilik ailenin rutini: otel transferi, çocuk dostu seçenekli akşam yemeği, Türk gecesi gösterisi, gece yarısına otele dönüş. 3 yaş altı ücretsiz, 4-10 yaş çocuk fiyatı, 24 saat öncesine kadar ücretsiz iptal. Yetişkin başına €30'dan başlar.",
    capsule:
      "4 kişilik bir aile için (2 yetişkin + 2 çocuk) en çok rezerve edilen seçenek Silver Soft akşam yemekli boğaz turu — yetişkin başına €30, 4-10 yaş için çocuk fiyatı (3 yaş altı ücretsiz), otel transferi dahil, 3,5 saatlik Boğaz rotası + çocuk dostu seçenekli yemek + Türk gecesi gösterisi. Çocuk yaşına göre toplam €100-€130. 24 saat öncesi ücretsiz iptal hasta-çocuk senaryosunu kapsar.",
    ...
    reasons: [
      ...
      { icon: Baby, title: "3 yaş altı ücretsiz · 4-10 yaş çocuk fiyatı", desc: "3 yaş altı çocuklar tüm paketlerde ücretsiz seyahat eder. 4-10 yaş çocuk fiyatı uygulanır (rezervasyonda teyit edilir). Akşam yemeği menüsünde çocuk dostu seçenekler var (ızgara tavuk, pilav, meyve) — 12 yaş altına balık zorlanmaz." },
    ...
    faqs: [
      ...
      { q: "Boğaz turu paketlerinde çocuk fiyatlandırması nasıl?", a: "3 yaş altı çocuklar tüm paketlerde ücretsiz seyahat eder. 4-10 yaş çocuklar çocuk fiyatından — genelde aynı paket yetişkin fiyatının %50'si. 11+ yaş yetişkin fiyatı öder. Paket ve tarihinize özel çocuk fiyatı rezervasyonda teyit edilir — WhatsApp'tan çocuk yaşlarını gönderin." },
      { q: "4 kişilik aile için en uygun Boğaz turu formatı?", a: "2 yetişkin + 2 çocuktan oluşan 4 kişilik aileler için en sık rezervasyon Silver Soft akşam yemekli tur (€30/yetişkin). Otel transferi, 3,5 saatlik rota, çocuk dostu seçenekli yemek ve aile dostu Türk gecesi eğlencesini içerir. 8+ kişilik aileler için özel yat (€280+) tüm tekneyi grup için özel zamanlamayla ayırır." },
  ...
  de: {
    ...
    metaDescription:
      "Familienfreundliche Bosporus-Kreuzfahrt — Hoteltransfer inkl., bis 3 J. kostenlos, 4-10 J. Kindertarif, 24-h-Stornierung. Ab €30/Erw., TÜRSAB A-lizenziert.",
    ...
    intro:
      "Familien-Routine: Hoteltransfer, Dinner mit kinderfreundlichen Optionen, Türkische Show, Rückkehr ins Hotel bis Mitternacht. Bis 3 J. kostenlos, 4-10 J. Kindertarif, kostenlose Stornierung 24 h vorher. Ab €30 pro Erwachsenem.",
    capsule:
      "Für eine 4-köpfige Familie (2 Erwachsene + 2 Kinder) ist die meistgebuchte Option das Silver-Soft-Dinner — €30/Erw., Kindertarif für 4-10 J. (bis 3 J. gratis), Hoteltransfer inkl., 3,5-h-Bosporus-Route + Dinner mit kinderfreundlichen Optionen + familienfreundliche Türkische Show. Gesamtabend für die Familie meist €100-€130 je nach Kindesalter. Kostenlose Stornierung 24 h vorher deckt kranke-Kind-Szenarien ab.",
    ...
    reasons: [
      ...
      { icon: Baby, title: "Bis 3 J. gratis · 4-10 J. Kindertarif", desc: "Kinder unter 3 reisen auf allen Paketen kostenlos. 4-10 J. erhalten Kindertarif (bei Buchung bestätigt). Dinner-Menü hat kinderfreundliche Optionen (gegrilltes Hähnchen, Reis, Obst) — kein Fischgang wird unter 12 J. gedrängt." },
    ...
    faqs: [
      ...
      { q: "Wie ist die Kinder-Preisstruktur?", a: "Kinder unter 3 reisen kostenlos. 4-10 J. zahlen Kindertarif — meist 50% des Erwachsenenpreises für das gleiche Paket. Ab 11 J. Erwachsenenpreis. Exakter Kindertarif wird bei Buchung bestätigt — Kindesalter per WhatsApp senden." },
      { q: "Beste Bosporus-Format für 4-köpfige Familie?", a: "Für Familien zu viert (2 Erw + 2 Kinder) am häufigsten gebucht: Silver Soft Dinner (€30/Erw). Hoteltransfer, 3,5-h-Route, kinderfreundliches Menü, familienfreundliche Türkische Show. Für 8+-köpfige Familien: privater Yacht-Charter (€280+, ganze Yacht mit individuellem Tempo)." },
  ...
  fr: {
    ...
    metaDescription:
      "Croisière Bosphore familiale — transfert hôtel inclus, gratuit pour les moins de 3 ans, tarif enfant 4-10 ans, annulation 24h. Dès €30/adulte, TÜRSAB A licencié.",
    ...
    reasons: [
      ...
      { icon: Baby, title: "Moins de 3 ans gratuit · 4-10 ans tarif enfant", desc: "Enfants de moins de 3 ans naviguent gratuitement sur tous forfaits. 4-10 ans : tarif enfant (confirmé à la réservation). Menu dîner a options enfant (poulet grillé, riz, fruits) — pas de poisson imposé aux moins de 12 ans." },
    ...
    faqs: [
      ...
      { q: "Quels sont les tarifs enfant ?", a: "Moins de 3 ans gratuit sur tous forfaits. 4-10 ans payent tarif enfant — généralement 50% du prix adulte pour le même forfait. 11+ tarif adulte. Tarif exact confirmé à la réservation — envoyer âges enfants via WhatsApp." },
      { q: "Meilleur format pour une famille de 4 ?", a: "Pour 4 (2 adultes + 2 enfants), la réservation la plus fréquente est le forfait Silver Soft dîner (€30/adulte). Transfert hôtel inclus, route 3 h 30, menu enfant, show nuit turque familial. Pour 8+ : yacht privé (€280+, yacht entier au rythme du groupe)." },
  ...
  nl: {
    ...
    metaDescription:
      "Gezinsvriendelijke Bosporus-cruise — hotel pickup, onder 3 j. gratis, 4-10 j. kindertarief, gratis 24h annulering. Vanaf €30/volwassene, TÜRSAB A.",
    ...
    intro:
      "Gezinsroutine: hotel pickup, diner met kindvriendelijke opties, Turkse avondshow, terug naar hotel voor middernacht. Onder 3 jaar gratis, 4-10 j. kindertarief, gratis annulering 24u vooraf. Vanaf €30 per volwassene.",
    capsule:
      "Voor een gezin van 4 (2 volwassenen + 2 kinderen) is de meest geboekte optie het Silver Soft diner — €30/volwassene, kindertarief voor 4-10 j. (onder 3 j. gratis), hotel pickup inbegrepen, 3,5 uur Bosporus-route + diner met kindvriendelijke opties + gezinsvriendelijke Turkse avondshow. Totale avond gezin €100-€130 afhankelijk van leeftijden. Gratis annulering 24u vooraf dekt zieke-kind-scenario's.",
    ...
    reasons: [
      ...
      { icon: Baby, title: "Onder 3 jaar gratis · 4-10 j. kindertarief", desc: "Kinderen onder 3 reizen gratis op alle pakketten. 4-10 j. krijgen kindertarief (bij boeking bevestigd). Diner-menu heeft kindvriendelijke opties (gegrilde kip, rijst, fruit) — geen vis opgedrongen aan kinderen onder 12." },
    ...
    faqs: [
      ...
      { q: "Wat is het kindertarief?", a: "Kinderen onder 3 jaar reizen gratis op alle pakketten. 4-10 j. krijgen kindertarief — meestal 50% van volwassen prijs voor hetzelfde pakket. 11+ volwassen prijs. Exact tarief bevestigd bij boeking — kinderleeftijden via WhatsApp sturen." },
      { q: "Beste Bosporus-formaat voor gezin van 4?", a: "Voor 4 (2 volw + 2 kinderen): meest geboekt is Silver Soft diner (€30/volw). Hotel pickup, 3,5 uur route, kindvriendelijk menu, gezinsvriendelijke Turkse avondshow. Voor 8+ gezinnen: privé-jachtcharter (€280+, hele jacht met groepsritme)." },
  ...
  ru: {
    ...
    metaDescription:
      "Семейный круиз по Босфору — отельный трансфер включён, до 3 лет бесплатно, тариф 4-10 лет, отмена 24 ч. От €30/взрослый, TÜRSAB A с 2001.",
    ...
    intro:
      "Семейный распорядок: отельный трансфер, ужин с детским меню, турецкое шоу, возвращение в отель до полуночи. До 3 лет бесплатно, 4-10 лет детский тариф, бесплатная отмена за 24 часа. От €30 за взрослого.",
    capsule:
      "Для семьи из 4 человек (2 взрослых + 2 ребёнка) самый бронируемый вариант — пакет Silver Soft ужин-круиз: €30/взрослый, детский тариф для 4-10 лет (до 3 лет бесплатно), отельный трансфер включён, маршрут по Босфору 3,5 часа + ужин с детским меню + семейное турецкое шоу. Общий вечер для семьи €100-€130 в зависимости от возраста детей. Бесплатная отмена за 24 часа покрывает сценарий с больным ребёнком.",
    ...
    reasons: [
      ...
      { icon: Baby, title: "До 3 лет бесплатно · 4-10 лет детский тариф", desc: "Дети младше 3 лет плавают бесплатно на всех пакетах. 4-10 лет получают детский тариф (подтверждается при бронировании). В меню ужина есть детские опции (куриный гриль, рис, фрукты) — рыба не навязывается младше 12 лет." },
    ...
    faqs: [
      ...
      { q: "Какие тарифы для детей?", a: "До 3 лет бесплатно на всех пакетах. 4-10 лет — детский тариф (обычно 50% от цены взрослого за тот же пакет). 11+ лет — взрослый тариф. Точный детский тариф подтверждается при бронировании — отправьте возраст детей через WhatsApp." },
      { q: "Лучший формат для семьи из 4 человек?", a: "Для семьи из 4 (2 взрослых + 2 детей) самое частое бронирование — Silver Soft ужин-круиз (€30/взрослый). Отельный трансфер, маршрут 3,5 часа, детское меню, семейное турецкое шоу. Для семей 8+ человек: частная яхта (€280+, вся яхта со своим темпом)." },
    ...
    ctaWhatsapp: "Семейный запрос через Telegram",
