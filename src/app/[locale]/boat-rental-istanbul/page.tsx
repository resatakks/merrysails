...
const TRANSLATIONS: Record<string, LocaleContent> = {
  ...
  ru: {
    title: "Аренда лодки в Стамбуле — От €380",
    description: `Аренда лодки в Стамбуле от €${startingRate} в час. Частная прогулка по Босфору, ужин и закат опционально. Запросите смету прямо сейчас.`,
    canonicalPath: "/ru/boat-rental-istanbul",
    eyebrow: "MerrySails Стамбул",
    heroTitle: "Аренда лодки в Стамбуле",
    heroDescription:
      `Частная аренда лодки на Босфоре от €${startingRate} в час. Сначала выберите судно и маршрут, потом по желанию добавьте ужин, тайминг заката или праздничные дополнения. Бронирование у Merry Tourism — TÜRSAB категория A с 2001 года, более 50 000 принятых гостей.`,
    fleetHeading: "Варианты флота",
    priceUnit: "/час",
    capacityLabel: "вместимость человек",
    lengthSeparator: " · ",
    howItWorksBox: {
      heading: "Как это работает",
      body: "Выберите лодку → укажите дату и продолжительность → получите смету в WhatsApp или по телефону. Марина и финальная цена подтверждаются на основе выбранной лодки, даты и дополнений.",
    },
    extrasHeading: "Дополнительные опции",
    extras: [
      "Ужин на борту (с выбором меню на человека)",
      "Тайминг под закат",
      "Оформление для предложения руки",
      "Профессиональный фотограф",
      "Торт на день рождения или юбилей",
      "Живая музыка или DJ",
      "Пакет напитков с алкоголем",
      "Вечерняя прогулка с городскими огнями",
    ],
    ctaWhatsapp: "Запросить смету в WhatsApp",
    breadcrumbHome: "Главная",
    breadcrumbCurrent: "Аренда лодки в Стамбуле",
    viewInEnglish: "Посмотреть на английском →",
    faqTitle: "Часто задаваемые вопросы",
    faqs: [
      { q: "Сколько стоит аренда лодки в Стамбуле?", a: `Часовые тарифы начинаются от €${startingRate}, в зависимости от типа и вместимости лодки. Стандартная аренда на 2 часа — от €${startingRate * 2}. Точная цена зависит от выбранной лодки, даты и дополнительных услуг.` },
      { q: "Какова минимальная продолжительность аренды?", a: "Минимум 2 часа. Аренда на полдня и полный день также доступна, с более выгодными тарифами для длительных бронирований." },
      { q: "Можно ли добавить ужин или кейтеринг?", a: "Да. Полный сервис кейтеринга с выбором меню на человека доступен. Выбирайте рыбное, мясное или вегетарианское меню и опционально добавляйте пакет напитков." },
      { q: "Можно ли арендовать лодку для предложения руки и сердца?", a: "Безусловно. Аренда лодки для предложения — один из самых популярных запросов. Мы организуем цветы, свечи, лепестки роз и профессионального фотографа в виде полного пакета по запросу." },
      { q: "Можем ли мы выбрать маршрут сами?", a: "Да. Выбирайте стандартные маршруты по Босфору или запрашивайте персональный маршрут: Принцевы острова, поход до Сарыера или переход на азиатскую сторону." },
      { q: "На сколько человек доступны лодки?", a: "Наш флот варьируется от небольших люкс-яхт на 2 человек до больших судов на 30+ человек. Для крупных групповых событий мы координируем и несколько лодок." },
    ],
    whyTitle: "Почему MerrySails?",
    whyItems: [
      { title: "Сертификация TÜRSAB категория A", desc: "Категория A с 2001 года. Безопасное бронирование, официальная страховка, юридическая гарантия." },
      { title: "Большой флот", desc: "От небольших люкс-яхт до крупных event-судов — более 10 вариантов." },
      { title: "Бесплатная отмена", desc: "Бесплатная отмена и полный возврат за 48 часов до отправления." },
      { title: "Сервис «всё в одном»", desc: "Ужин, фотограф, оформление, музыка — всё в одном месте." },
    ],
  },
};
