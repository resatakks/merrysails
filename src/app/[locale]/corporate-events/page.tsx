...
const TRANSLATIONS: Record<string, LocaleContent> = {
  ...
  ru: {
    metaTitle: "Корпоративное мероприятие на Босфоре — Стамбул",
    metaDescription:
      "Корпоративное мероприятие на Босфоре: командный ужин, приём клиентов, запуск продукта и бизнес-вечер в Стамбуле на частной яхте. По смете, с официальным счётом.",
    canonicalPath: "/ru/corporate-events",
    breadcrumbHome: "Главная",
    breadcrumbCurrent: "Корпоративные мероприятия",
    heroTitle: "Корпоративное мероприятие на Босфоре",
    heroSubtitle:
      "Командные ужины, приёмы клиентов и запуски продуктов в Стамбуле на частной яхте",
    heroDescription:
      "Корпоративные мероприятия MerrySails резервируют всю яхту эксклюзивно для вашего командного ужина, приёма клиентов, запуска продукта или бизнес-вечера. Поток гостей, кейтеринг, брендинг и выставление счетов настраиваются под ваш бриф — не стандартный пакет, а формат под событие.",
    whyHeading: "Почему MerrySails для вашего корпоративного события?",
    reasons: [
      {
        title: "Планирование на основе вашего брифа",
        desc: "Гостевой лист, тайминг и сервисные пожелания обсуждаются в первую очередь; яхта и коммерческая структура следуют за событием, не за стандартным пакетом.",
      },
      {
        title: "Официальный счёт и корпоративные документы",
        desc: "Официальное выставление счетов, корректные документы и коммерческая ясность, как этого требует ваш финансовый отдел.",
      },
      {
        title: "Брендинг и сценическая поддержка",
        desc: "Сетап для запуска продукта, презентаций, микрофонов, экранов, бренд-стайлинга и фото/видео-поддержки под ваше событие.",
      },
    ],
    formatsHeading: "Форматы корпоративных событий",
    formats: [
      {
        title: "Командный ужин",
        desc: "Идеально, если вы хотите собрать всю команду в приватной обстановке с чётким планом рассадки, меню и обслуживания.",
      },
      {
        title: "Приём клиентов",
        desc: "Подходит, когда событию нужна более запоминающаяся атмосфера, чем обычный ресторан или отель.",
      },
      {
        title: "Запуск продукта / шоукейс",
        desc: "Для запусков, где визуальный эффект, тайминг и брендированное оформление так же важны, как и сама локация.",
      },
      {
        title: "Вечер совета директоров / топ-менеджмента",
        desc: "Когда приватность, контроль тайминга и спокойная атмосфера на борту важнее масштаба.",
      },
    ],
    faqHeading: "Часто задаваемые вопросы",
    faqs: [
      {
        q: "Как рассчитывается цена корпоративного события на яхте?",
        a: "Цена зависит от числа гостей, тайминга, уровня кейтеринга, потребностей в брендинге и типа яхты, подходящего под бриф. Все события планируются по смете.",
      },
      {
        q: "Будет ли у нас официальный счёт?",
        a: "Да. Корпоративные бронирования оформляются с официальным счётом и всеми коммерческими документами, которые нужны вашему финансовому отделу.",
      },
      {
        q: "Какие корпоративные форматы подходят на борту?",
        a: "Командные ужины, приёмы клиентов, директорские ужины, запуски, инсентив-вечера и корпоративные праздники — все хорошо организуются на Босфоре.",
      },
      {
        q: "Какие варианты кейтеринга и напитков доступны?",
        a: "Фиксированное меню, фуршет, hapjes-сервис или индивидуальное меню от приватного шефа. Пакеты напитков (с алкоголем или без) формируются на основе вашего брифа.",
      },
    ],
