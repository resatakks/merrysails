...
const CONTENT: Record<string, LocaleContent> = {
 ...
 metaDescription:
 "Çiftler için Boğaz turu: gün batımı €30 (Pzt/Sal/Per), özel akşam yemeği €220, evlilik teklifi yatı. Aracısız doğrudan rezervasyon.",
 canonicalPath: "/tr/bosphorus-cruise-for-couples",
 eyebrow: "Romantizm · İki kişilik",
 h1: "İstanbul Boğaz Turu Çiftler İçin",
 intro: "Üç format çiftler için farklı çalışır. Paylaşımlı gün batımı en hafifi — çift için 2 saat altın saat €30-€40. Paylaşımlı akşam yemeği bütün akşamı kapsar — €60-€180. Özel yat tüm tekneyi €220'den ayırır — yıldönümü ve evlilik teklifi için en uygunu.",
 ...
 { icon: Heart, title: "Yatta özel akşam yemeği (€220+)", desc: "Sadece ikiniz (veya size en yakınlarınız). Tüm yat sizindir, özel zamanlama, menü rezervasyonda seçilir. Yıldönümü için en iyi.", href: "/tr/private-bosphorus-dinner-cruise", badge: "Premium" },
 { icon: Music, title: "Evlilik teklifi yatı (€220+)", desc: "Kruvazın evlilik teklifi anı olduğu durumda — sürpriz dekoru, fotoğrafçı, kemancı, gün batımına göre rota.", href: "/tr/proposal-yacht-rental-istanbul" },
 ],
 faqHeading: "Çiftler için SSS",
 faqs: [
 { q: "Çiftler için en uygun Boğaz turu hangisidir?", a: "Hafif ilk gece için paylaşımlı gün batımı (€30 Pzt/Sal/Per). Tam akşam için paylaşımlı akşam yemeği (€30-€90 dört paket). Yıldönümü veya teklif için özel yat (€220+, tüm tekne)." },
 { q: "Paylaşımlı akşam yemeği çift için kalabalık değil mi?", a: "Bağlıdır. Paylaşımlı tekne festive — başka çiftler ve küçük gruplar var, canlı Türk gecesi eğlencesi, restoran sessizliği değil. Sadece-ikiniz isteği için özel yatta akşam yemeği (€220+) — aynı Boğaz rotası, paylaşımlı oturma yok." },
 { q: "İki kişi için paylaşımlı ve özel arasındaki fiyat farkı?", a: "2 kişi için: paylaşımlı gün batımı = €60-€68. Paylaşımlı dinner Silver Soft = €60. Özel 2-saat yat = €220 (tüm tekne, grup büyüklüğüne bakılmaz). Özele geçiş paylaşımlının 4-5 katı ama tüm tekne, özel zamanlama, başka misafir yok." },
 ...
 metaDescription:
 "Bosporus-Kreuzfahrt für Paare: Sonnenuntergang €30 (Mo/Di/Do), privates Dinner €220, Antrags-Yacht. Direktbuchung ohne OTA-Aufschlag.",
 canonicalPath: "/de/bosphorus-cruise-for-couples",
 eyebrow: "Romantik · Zu zweit",
 h1: "Bosporus-Kreuzfahrt für Paare Istanbul",
 intro: "Drei Formate funktionieren unterschiedlich für Paare. Geteilter Sonnenuntergang ist die leichteste Option — 2 Stunden Goldene Stunde für €30-€40 pro Paar. Geteiltes Dinner deckt einen ganzen Abend ab — €60-€180. Private Yacht reserviert das ganze Schiff ab €220 — ideal für Hochzeitstag oder Antrag.",
 capsule: "Bosporus-Kreuzfahrt für Paare in Istanbul gibt es in drei Formaten: geteilter Sonnenuntergang €30 (Mo/Di/Do), geteiltes Dinner €30-€90 (Hoteltransfer inkl.), private Yacht ab €220 (ganzes Schiff nur für das Paar). Pro-Yacht, nicht pro Person. Wenn Sie eine Überraschung zum Antrag planen, unterstützt das Privat-Yacht-Format die Mechanik — geteiltes Format nicht.",
 ...
 { icon: Heart, title: "Privates Dinner auf der Yacht (€220+)", desc: "Nur Sie zwei (oder Ihre engsten Liebsten). Die ganze Yacht ist Ihre, individuelles Timing, Menü bei Buchung. Ideal für Hochzeitstag.", href: "/de/private-bosphorus-dinner-cruise", badge: "Premium" },
 { icon: Music, title: "Antrags-Yacht (€220+)", desc: "Wenn die Fahrt der Antrags-Moment selbst ist — Überraschungs-Styling, Fotograf, Geiger, auf Sonnenuntergang getimt.", href: "/de/proposal-yacht-rental-istanbul" },
 ],
 faqHeading: "FAQ für Paare",
 faqs: [
 { q: "Welche Bosporus-Kreuzfahrt passt für Paare?", a: "Leichter erster Abend: geteilter Sonnenuntergang (€30 Mo/Di/Do). Voller Abend: geteiltes Dinner (€30-€90, vier Pakete). Für Hochzeitstag oder Antrag: private Yacht (€220+, ganze Yacht)." },
 { q: "Ist das geteilte Dinner zu voll für ein romantisches Paar?", a: "Hängt vom gewünschten Format ab. Geteiltes Dinner = festlich (Türkische Show, andere Paare und kleine Gruppen, kein Restaurant-Stille). Für nur-zu-zweit-Setting: privates Dinner auf Yacht (€220+) — gleiche Route, kein geteiltes Sitzen." },
 { q: "Preisunterschied zwischen geteilt und privat für 2 Personen?", a: "Für 2 Gäste: geteilter Sonnenuntergang = €60-€68 gesamt. Geteiltes Dinner Silver Soft = €60. Private 2-h-Yacht = €220 (ganze Yacht, unabhängig von Gruppengröße). Privat-Upgrade ist 4-5× geteilt, aber Sie haben ganze Yacht, individuelles Timing, keine fremden Gäste." },
 ...
 metaDescription:
 "Croisière Bosphore pour couples : coucher de soleil €30 (lun/mar/jeu), dîner privé €220, demande en mariage. Réservation directe sans commission OTA.",
 canonicalPath: "/fr/bosphorus-cruise-for-couples",
 eyebrow: "Romance · À deux",
 h1: "Croisière Bosphore pour Couples à Istanbul",
 intro: "Trois formats fonctionnent différemment pour les couples. Coucher de soleil partagé = le plus léger — 2 h d'heure dorée pour €30-€40 le couple. Dîner partagé couvre toute la soirée — €60-€180. Yacht privé réserve l'embarcation entière dès €220 — idéal pour anniversaire ou demande en mariage.",
 capsule: "La croisière Bosphore pour couples à Istanbul existe en trois formats : coucher de soleil partagé €30 (lun/mar/jeu), dîner partagé €30-€90 (transfert hôtel inclus), yacht privé dès €220 (yacht entier réservé pour le couple). Tarif au yacht, pas par personne. Pour une surprise de demande en mariage, seul le format yacht privé permet la mécanique surprise — le format partagé non.",
 ...
 { icon: Heart, title: "Dîner privé sur yacht (€220+)", desc: "Seulement vous deux (ou vos proches). Yacht entier réservé, timing custom, menu choisi à la réservation. Idéal pour anniversaire.", href: "/fr/private-bosphorus-dinner-cruise", badge: "Premium" },
 { icon: Music, title: "Yacht de demande en mariage (€220+)", desc: "Quand la croisière EST le moment de la demande — styling surprise, photographe, violoniste, route au coucher du soleil.", href: "/fr/proposal-yacht-rental-istanbul" },
 ],
 faqHeading: "FAQ couples",
 faqs: [
 { q: "Quelle croisière Bosphore convient aux couples ?", a: "Soirée légère : coucher de soleil partagé (€30 lun/mar/jeu). Soirée complète : dîner partagé (€30-€90 quatre forfaits). Pour anniversaire ou demande : yacht privé (€220+, yacht entier)." },
 { q: "Le dîner partagé est-il trop chargé pour un couple ?", a: "Dépend du format souhaité. Dîner partagé = ambiance festive (autres couples, show nuit turque, pas le silence d'un restaurant). Pour ambiance vous-deux-seulement : dîner privé sur yacht (€220+) — même route, pas d'assises partagées." },
 { q: "Écart de prix partagé vs privé pour 2 personnes ?", a: "Pour 2 : coucher de soleil partagé = €60-€68 total. Dîner Silver Soft = €60. Yacht privé 2 h = €220 (yacht entier, peu importe la taille du groupe). Le privé = 4-5× le partagé mais yacht complet, timing custom, aucun invité tiers." },
 ...
 metaDescription:
 "Bosporus-cruise voor stellen: zonsondergang €30 (ma/di/do), privé-diner €220, huwelijksaanzoek-jacht. Direct boeken, geen OTA-opslag.",
 canonicalPath: "/nl/bosphorus-cruise-for-couples",
 eyebrow: "Romantiek · Met z'n tweeën",
 h1: "Bosporus-Cruise voor Stellen Istanbul",
 intro: "Drie formaten werken verschillend voor stellen. Gedeelde zonsondergang = het lichtste — 2 uur gouden uur voor €30-€40 voor het stel. Gedeeld diner dekt de hele avond — €60-€180. Privé-jacht reserveert de hele boot vanaf €220 — ideaal voor trouwdag of huwelijksaanzoek.",
 capsule: "De Bosporus-cruise voor stellen in Istanbul bestaat in drie formaten: gedeelde zonsondergang €30 (ma/di/do), gedeeld diner €30-€90 (hotel pickup inbegrepen), privé-jacht vanaf €220 (hele jacht voor het stel). Per jacht, niet per persoon. Voor een huwelijksaanzoek-verrassing werkt alleen het privé-formaat — gedeeld kan de verrassings-mechaniek niet ondersteunen.",
 ...
 { icon: Heart, title: "Privé-diner op een jacht (€220+)", desc: "Alleen u beiden (of uw naasten). Hele jacht gereserveerd, custom timing, menu gekozen bij boeking. Ideaal voor trouwdag.", href: "/nl/private-bosphorus-dinner-cruise", badge: "Premium" },
 { icon: Music, title: "Huwelijksaanzoek-jacht (€220+)", desc: "Wanneer de cruise HET aanzoek-moment is — verrassings-styling, fotograaf, violist, route op zonsondergang.", href: "/nl/proposal-yacht-rental-istanbul" },
 ],
 faqHeading: "FAQ voor stellen",
 faqs: [
 { q: "Welke Bosporus-cruise is het beste voor stellen?", a: "Lichte eerste avond: gedeelde zonsondergang (€30 ma/di/do). Volle avond: gedeeld diner (€30-€90, vier pakketten). Voor trouwdag of aanzoek: privé-jacht (€220+, hele jacht)." },
 { q: "Is gedeeld diner te druk voor een romantisch stel?", a: "Hangt van het gewenste formaat af. Gedeeld diner = feestelijke sfeer (andere stellen, Turkse avondshow, geen restaurant-stilte). Voor alleen-u-tweeën-instelling: privé-diner op een jacht (€220+) — zelfde route, geen gedeelde zitplaatsen." },
 { q: "Prijsverschil gedeeld vs privé voor 2 personen?", a: "Voor 2: gedeelde zonsondergang = €60-€68 totaal. Gedeeld diner Silver Soft = €60. Privé 2-uurs jacht = €220 (hele jacht, ongeacht groep). Privé-upgrade is 4-5× gedeeld, maar u krijgt hele jacht, custom timing, geen andere gasten." },
 ...
 metaDescription:
 "Круиз по Босфору для пар: закат €30 (пн/вт/чт), приватный ужин €220, яхта для предложения руки. Прямое бронирование без комиссий OTA.",
 canonicalPath: "/ru/bosphorus-cruise-for-couples",
 eyebrow: "Романтика · Для двоих",
 h1: "Круиз по Босфору для Пар в Стамбуле",
 intro: "Три формата работают по-разному для пар. Общий закатный круиз — самый лёгкий — 2 часа золотого часа за €30-€40 на пару. Общий ужин-круиз покрывает весь вечер — €60-€180. Частная яхта резервирует всё судно от €220 — идеально для годовщины или предложения руки.",
 capsule: "Круиз по Босфору для пар в Стамбуле бывает трёх форматов: общий закат €30 (пн/вт/чт), общий ужин €30-€90 (с отельным трансфером), частная яхта от €220 (вся яхта для пары). Цена за яхту, не за человека. Для сюрприза с предложением руки подходит только формат частной яхты — общий формат не позволяет реализовать механику сюрприза.",
 ...
 { icon: Heart, title: "Частный ужин на яхте (€220+)", desc: "Только вы вдвоём (или ваши близкие). Вся яхта зарезервирована, индивидуальный тайминг, меню выбирается при бронировании. Идеально для годовщины.", href: "/ru/private-bosphorus-dinner-cruise", badge: "Премиум" },
 { icon: Music, title: "Яхта для предложения руки (€220+)", desc: "Когда круиз и есть момент предложения — оформление-сюрприз, фотограф, скрипач, маршрут к закату.", href: "/ru/proposal-yacht-rental-istanbul" },
 ],
 faqHeading: "FAQ для пар",
 faqs: [
 { q: "Какой круиз по Босфору лучше для пар?", a: "Лёгкий первый вечер: общий закатный (€30 пн/вт/чт). Полный вечер: общий ужин (€30-€90, четыре пакета). Для годовщины или предложения: частная яхта (€220+, вся яхта)." },
 { q: "Не слишком ли многолюдно на общем ужине для романтической пары?", a: "Зависит от желаемого формата. Общий ужин = праздничная атмосфера (другие пары, турецкое шоу, не ресторанная тишина). Для только-вы-вдвоём: частный ужин на яхте (€220+) — тот же маршрут, без общих посадок." },
 { q: "Разница в цене общий vs частный для двоих?", a: "Для 2 человек: общий закат = €60-€68. Общий ужин Silver Soft = €60. Частная 2-час. яхта = €220 (вся яхта, неважно сколько человек). Апгрейд до частного — 4-5× общий, но вся яхта, индивидуальный тайминг, никаких других гостей." },
