    ...
    faqSection: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Вы можете связаться с нами через Telegram (@merrysails) или по телефону +90 544 898 98 12. Telegram — предпочтительный канал для гостей из России: переписка на русском, быстрый ответ и подтверждение бронирования в течение нескольких минут в рабочее время.",
        },
      ],
    },
    bottomCta: {
      heading: "Забронируйте Ваш круиз по Босфору",
      intro: "Напишите нам в Telegram (@merrysails) или оформите бронирование онлайн.",
      bookButton: "Онлайн-бронирование",
      whatsappButton: "Написать в Telegram",
    },
  },
};
