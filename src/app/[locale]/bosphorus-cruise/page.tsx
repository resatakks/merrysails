...
const CONTENT: Record<string, LocaleContent> = {
  ...
  de: {
    ...
    faqs: [
      { q: "Was kostet eine Bootsfahrt auf dem Bosporus Istanbul?", a: "Eine Bootsfahrt auf dem Bosporus Istanbul kostet ab €30 pro Person (Dienstag und Donnerstag) bzw. €34 (andere Tage) für die Sonnenuntergangs-Tour (2 Stunden, ohne Wein). Die Dinner-Kreuzfahrt beginnt bei €30 pro Person. Eine vollständig private Jacht gibt es ab €280 pro Boot — egal ob für 2 oder 20 Personen. Alle Preise verstehen sich inklusive Kapitän, Crew und Grundausstattung; keine versteckten Extragebühren." },
  ...
  fr: {
    ...
    faqs: [
      { q: "Quel est le prix d'une croisière Bosphore Istanbul ?", a: "Une croisière Bosphore Istanbul coûte à partir de €30 par personne (mardi et jeudi) ou €34 (autres jours) pour la croisière coucher de soleil (2h). La croisière dîner commence à €30/personne. Le charter de yacht privé est disponible à partir de €200 par bateau. Tous les prix incluent le capitaine, l'équipage et les accompagnements de base." },
