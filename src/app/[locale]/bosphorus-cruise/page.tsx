...
const CONTENT: Record<string, LocaleContent> = {
 ...
 intro: "İstanbul boğaz turu seçeneklerimiz: gün batımı boğaz turu €30'dan (Sal & Per), yemekli boğaz turu €30'dan, özel yat kiralama €280'den. TÜRSAB A Grubu lisanslı, 2001'den bu yana 50.000'i aşkın misafir. Doğrudan rezervasyon, aracısız fiyat.",
 ...
 compareItems: [
 { title: "Süre ve bütçe", desc: "2 saatlik hafif bir deneyim için gün batımı turu (€30 Sal & Per, €34 diğer günler), tam akşam programı için yemekli tur (€30–€90), tam özelleştirme için yat kiralama (€280+)." },
 ...
 faqs: [
 { q: "Was kostet eine Bootsfahrt auf dem Bosporus Istanbul?", a: "Eine Bootsfahrt auf dem Bosporus Istanbul kostet ab €30 pro Person (Montag, Dienstag und Donnerstag) bzw. €34 (andere Tage) für die Sonnenuntergangs-Tour (2 Stunden, ohne Wein). Die Dinner-Kreuzfahrt beginnt bei €30 pro Person. Eine vollständig private Jacht gibt es ab €280 pro Boot — egal ob für 2 oder 20 Personen. Alle Preise verstehen sich inklusive Kapitän, Crew und Grundausstattung; keine versteckten Extragebühren." },
 ...
 description: "Croisière Bosphore Istanbul : coucher de soleil dès €30 (mar & jeu), dîner dès €30, yacht privé dès €200. Agence TÜRSAB groupe A, 50 000+ clients. Réservez en ligne.",
 canonicalPath: "/fr/bosphorus-cruise",
 h1: "Croisière Bosphore Istanbul",
 subtitle: "MerrySails Istanbul",
 intro: "Comparez toutes les options de croisière sur le Bosphore à Istanbul : coucher de soleil dès €30 (mar & jeu), dîner dès €30, yacht privé dès €200. Agence certifiée TÜRSAB depuis 2001, plus de 50 000 clients satisfaits.",
 ...
 compareItems: [
 { title: "Durée et budget", desc: "Coucher de soleil (dès €30 mar & jeu, €34 autres jours) pour 2h légères, dîner (€30–€90) pour une soirée complète, yacht privé (€200+) pour une intimité totale." },
 ...
 faqs: [
 { q: "Quel est le prix d'une croisière Bosphore Istanbul ?", a: "Une croisière Bosphore Istanbul coûte à partir de €30 par personne (lundi, mardi et jeudi) ou €34 (autres jours) pour la croisière coucher de soleil (2h). La croisière dîner commence à €30/personne. Le charter de yacht privé est disponible à partir de €200 par bateau. Tous les prix incluent le capitaine, l'équipage et les accompagnements de base." },
 ...
 description: "Bosporus cruise Istanbul: zonsondergang vanaf €30 (di & do), diner cruise vanaf €30, privéjacht vanaf €280. TÜRSAB A-groep, 50.000+ gasten. Direct boeken.",
 canonicalPath: "/nl/bosphorus-cruise",
 h1: "Bosporus Cruise Istanbul",
 subtitle: "MerrySails Istanbul",
 intro: "Vergelijk alle Bosporus cruise-opties in Istanbul: zonsondergang vanaf €30 (di & do), diner vanaf €30, privéjacht vanaf €280. Gecertificeerd door TÜRSAB A-groep sinds 2001 en meer dan 50.000 tevreden gasten.",
 ...
 compareItems: [
 { title: "Duur en budget", desc: "Zonsondergang (v.a. €30 di & do, €34 andere dagen) voor 2 uur lichte ervaring, diner (€30–€90) voor een volledige avond, privéjacht (€280+) voor maximale privacy." },
 ...
 description:
 "Круиз по Босфору в Стамбуле: круиз на закате от €30 (пн/вт/чт), ужин-круиз от €30, частная аренда яхты от €200. Лицензия TÜRSAB А, 50 000+ гостей с 2001 года. Прямое бронирование.",
 canonicalPath: "/ru/bosphorus-cruise",
 h1: "Круиз по Босфору — Стамбул",
 subtitle: "Эксклюзивный Босфор от MerrySails",
 intro: "Наши варианты круизов по Босфору в Стамбуле: круиз на закате от €30 (пн/вт/чт), ужин-круиз от €30, частная аренда яхты от €200 за судно. Лицензия TÜRSAB А с 2001 года, более 50 000 гостей. Прямое бронирование без наценок OTA.",
 ...
 { label: "Частная яхта", value: "от €200 (за судно)" },
 ...
 { slug: "yacht", title: "Частная аренда яхты", price: "€200", duration: "2+ часа", tag: "Полностью приватно", desc: "Вся яхта только для Вас. Идеально для предложения руки и сердца, дня рождения, семейного праздника, корпоратива." },
 ...
 { name: "Частная яхта (2 часа)", price: "€200 / яхта", duration: "2 часа", included: "Вся яхта Вам, до 10-12 гостей" },
 ],
 compareSectionTitle: "Какой круиз по Босфору Вам подходит?",
 compareItems: [
 { title: "Время и бюджет", desc: "Для 2-часового лёгкого опыта — круиз на закате (€30 пн/вт/чт, €34 другие дни). Полный вечер — ужин-круиз (€30–€90). Полная кастомизация — частная яхта (€200+)." },
 ...
 faqs: [
 { q: "Сколько стоит круиз по Босфору в 2026?", a: "Цены MerrySails от €30 на человека: круиз на закате €30 (пн/вт/чт) / €34 (другие дни); ужин-круиз €30 – €90 (4 пакета); частная яхта €200 за судно (до 10-12 гостей единой ценой). Пакет с трансфером €90. Прямое бронирование — выгоднее OTA на 20%." },
