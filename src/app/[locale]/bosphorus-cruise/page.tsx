...
const CONTENT: Record<string, LocaleContent> = {
 ...
 { q: "Tekne turunda çocuk indirimi var mı?", a: "3 yaş altı bebekler ücretsizdir. 3–13 yaş arası çocuklara %50 indirim uygulanır. Rezervasyon sırasında çocuk sayısını ve yaşlarını belirtmenizi öneririz." },
 ...
 { q: "Gibt es Kinderermäßigungen?", a: "Kinder unter 3 Jahren sind kostenlos. Für Kinder von 3 bis 13 Jahren gilt 50 % Ermäßigung auf den regulären Preis. Bitte geben Sie Anzahl und Alter der Kinder bei der Buchung an, damit wir die korrekte Kapazität und das passende Kindermenü (bei Dinner-Touren) vorbereiten können." },
 ...
 { q: "Y a-t-il des réductions pour les enfants ?", a: "Les enfants de moins de 3 ans voyagent gratuitement. Les enfants de 3 à 13 ans bénéficient de 50 % de réduction. Merci d'indiquer l'âge des enfants lors de la réservation." },
 ...
 { q: "Is er korting voor kinderen?", a: "Kinderen onder 3 jaar zijn gratis. Kinderen van 3–13 jaar krijgen 50% korting. Vermeld de leeftijd van kinderen bij de reservering." },
 ...
 { q: "Есть ли детская скидка?", a: "0–3 года бесплатно. 3–13 лет — 50% скидка. 13+ — взрослый тариф. Укажите количество и возраст детей при бронировании." },
 ...
 { q: "游船有儿童折扣吗?", a: "0–3 岁婴儿免费;3–13 岁儿童 50% 折扣;13 岁以上按成人价。预订时请告知儿童数量和年龄。" },
