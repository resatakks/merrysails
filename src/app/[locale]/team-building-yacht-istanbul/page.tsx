...
const TRANSLATIONS: Record<string, LocaleContent> = {
  ...
  ru: {
    metaTitle: "Тимбилдинг на яхте Стамбул — Босфор корпоратив",
    metaDescription:
      "Тимбилдинг на частной яхте на Босфоре в Стамбуле: совместный опыт, эксклюзивный групповой формат и корпоративная сплочённость намного выше, чем ресторанный вечер.",
    canonicalPath: "/ru/team-building-yacht-istanbul",
    breadcrumbHome: "Главная",
    breadcrumbCurrent: "Тимбилдинг на яхте Стамбул",
    eyebrow: "Корпоративное групповое мероприятие",
    heroTitle: "Тимбилдинг на яхте в Стамбуле",
    heroDesc:
      "Соберите свою команду на частной яхте на Босфоре. Эксклюзивный формат для динамики команды и сплочённости — намного выше переговорной комнаты и ресторанного ужина.",
    whyHeading: "Почему тимбилдинг на яхте?",
    reasons: [
      {
        title: "Совместный опыт",
        desc: "Совместное время на Босфоре, общие моменты и уникальная локация укрепляют командные связи намного сильнее обычного ужина.",
      },
      {
        title: "Эксклюзивный групповой формат",
        desc: "Всё судно — для вашей команды, без посторонних. Активности, сервис и программа формируются на основе вашего брифа.",
      },
      {
        title: "Панорама Босфора",
        desc: "Мосты, прибрежные особняки и силуэт Босфора создают незабываемый фон для вашего корпоративного события.",
      },
    ],
    faqHeading: "Часто задаваемые вопросы",
    faqs: [
      {
        q: "На какое количество человек подходит?",
        a: "От небольших команд лидеров до более крупных отделов — доступны разные яхты. Сообщите размер группы, и мы порекомендуем подходящее судно.",
      },
      {
        q: "Можно ли организовать командные активности?",
        a: "Да, по запросу могут быть добавлены командные активности, квизы или соревновательные форматы. Достаточно соответствующего брифа.",
      },
      {
        q: "Будет ли выставлен официальный счёт?",
        a: "Да. Официальные счета и документы для корпоративного процесса оплаты предоставляются.",
      },
    ],
    ctaHeading: "Поделитесь брифом",
    ctaDesc: "Отправьте размер группы, дату и формат события — мы быстро ответим.",
    ctaBtn: "Запросить смету в WhatsApp",
  },
};
