  ...
  ru: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Пишите нам в Telegram (@merrysails) — отвечаем на русском, подтверждение брони в течение нескольких минут в рабочее время. Доступен также телефон +90 544 898 98 12. WhatsApp не используется как канал связи для гостей из России.",
      },
    ],
