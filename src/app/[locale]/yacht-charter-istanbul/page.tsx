...
const TRANSLATIONS: Record<string, LocaleContent> = {
  ...
  ru: {
    ...
    howItWorks: {
      ...
      steps: [
        "Напишите нам в Telegram (@merrysails) или по телефону +90 544 898 98 12 — укажите дату, время и количество гостей для проверки доступности.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Telegram (@merrysails) — основной канал связи для гостей из России: переписка на русском, подтверждение брони за несколько минут в рабочее время. Доступен также телефон +90 544 898 98 12. WhatsApp в качестве канала связи для гостей из России мы не используем.",
      },
    ],
    ...
    ctaWhatsapp: "Написать в Telegram",
    ctaPhone: "Позвонить",
