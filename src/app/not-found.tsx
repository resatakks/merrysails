  ...
  return (
    <div className="min-h-screen bg-deep-navy flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <h1 className="font-heading text-6xl md:text-8xl font-bold text-white mb-4">404</h1>
        <h2 className="font-heading text-2xl text-white/80 mb-4">Sayfa Bulunamadı</h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/"
            className="bg-sunset hover:bg-sunset-light text-white px-8 py-3 rounded-lg font-semibold transition-colors"
          >
            Ana Sayfaya Dön
          </Link>
          <Link
