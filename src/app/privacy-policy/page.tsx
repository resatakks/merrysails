  ...
  return (
    <section className="section-padding pt-32">
      <div className="max-w-3xl mx-auto prose prose-lg">
        <h1 className="font-heading text-4xl font-bold text-deep-navy">Gizlilik Politikası</h1>
        <p className="text-gray-400 text-sm">Son güncelleme: 1 Mart 2026</p>

        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">1. Veri Sorumlusu</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">2. Toplanan Veriler</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">3. Verilerin Kullanım Amacı</h2>
        <ul className="text-gray-600 list-disc pl-6 space-y-1">
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">4. Çerez Politikası</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">5. Haklarınız</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">6. İletişim</h2>
