  ...
  return (
    <section className="section pt-32">
      <div className="max-w-3xl mx-auto prose prose-lg">
        <h1 className="text-4xl font-bold text-heading">Kullanım Koşulları</h1>
        <p className="text-gray-400 text-sm">Son güncelleme: 1 Mart 2026</p>

        <h2 className="text-2xl font-bold text-heading mt-8">1. Genel</h2>
        ...
        <h2 className="text-2xl font-bold text-heading mt-8">2. Rezervasyon Koşulları</h2>
        ...
        <h2 className="text-2xl font-bold text-heading mt-8">3. Fiyatlandırma</h2>
        ...
        <h2 className="text-2xl font-bold text-heading mt-8">4. Sorumluluk</h2>
        ...
        <h2 className="text-2xl font-bold text-heading mt-8">5. Fikri Mülkiyet</h2>
