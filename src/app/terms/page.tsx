  ...
  return (
    <section className="section-padding pt-32">
      <div className="max-w-3xl mx-auto prose prose-lg">
        <h1 className="font-heading text-4xl font-bold text-deep-navy">Kullanım Koşulları</h1>
        <p className="text-gray-400 text-sm">Son güncelleme: 1 Mart 2026</p>

        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">1. Genel</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">2. Rezervasyon Koşulları</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">3. Fiyatlandırma</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">4. Sorumluluk</h2>
        ...
        <h2 className="font-heading text-2xl font-bold text-deep-navy mt-8">5. Fikri Mülkiyet</h2>
