...
const faqItemsRu = [
 ...
 a: "Ужин-круиз с пирса Кабаташ начинается от 30 EUR с человека (пакет Silver Soft Drinks). Gold Unlimited Alcohol — 90 EUR с VIP-местами и трансфером. Оператор лицензирован TÜRSAB Группы А. Уточните актуальные тарифы в WhatsApp.",
 },
 {
 q: "Как добраться до причала Кабаташ (Kabataş)?",
 a: "Причал Кабаташ находится у подножия дворца Долмабахче. Добраться можно: трамваем T1 до остановки Kabataş, фуникулёром F1 от Таксима, или такси (10–15 минут от Султанахмета). Рекомендуем прибыть за 15 минут до отправления. Точные координаты — в WhatsApp.",
 },
 {
 q: "Что включено в ужин-круиз от Кабаташ?",
 a: "В стандартный пакет включены: 3,5 часа на яхте, мезе, основное блюдо, безалкогольные напитки, турецкое шоу с танцем живота и фольклорной программой. Пакеты Gold добавляют алкоголь и VIP-места. Лицензия TÜRSAB Группы А. Подробности в WhatsApp.",
 },
 {
 q: "Доступен ли трансфер от отеля до Кабаташ?",
 a: "Да, трансфер от отеля доступен для гостей из Султанахмета, Таксима, Сиркеджи и Каракёя (в пакете Gold или как опция). После сбора гостей доставляют прямо к пирсу Кабаташ. Согласовать трансфер можно в WhatsApp.",
 },
];
...
export default function KabatasDinnerCruiseIstanbulPage() {
 ...
 >Kabatas Dinner Cruise Istanbul</span>
 </nav>
