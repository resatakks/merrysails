...
export const metadata = {
  ...
  description:
    "Compare private Bosphorus event types in Istanbul — proposals, anniversaries, family cruises, corporate hosting. Whole-yacht booking from €280, TURSAB licensed.",
  alternates: {
