...
const faqs = [
  {
    ...
    a: "Prices depend on the experience you choose. The Bosphorus Sunset Cruise starts from EUR 30 per person (every Tuesday and Thursday) — EUR 34 on other days for Without Wine and EUR 40 for the wine-served option. The Bosphorus Dinner Cruise spans EUR 30 to EUR 90 across four shared packages, and Yacht Charter Istanbul starts from EUR 200 per yacht. Proposal, private dinner, boat rental, and corporate events are priced according to the setup you request.",
  },
  {
