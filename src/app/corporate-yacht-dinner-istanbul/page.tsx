...
const faqItemsRu = [
 ...
 a: "Стоимость зависит от выбранной яхты и продолжительности. Цена указывается за всё судно: Group Yacht 40 (до 40 гостей) от 380 EUR за 2 часа, Event Yacht 90 (до 90 гостей) — по запросу. Для меньших групп подойдёт Boutique Yacht (до 12 гостей) от 220 EUR. С 3 часов — автоматическая скидка 10%. Оператор TÜRSAB Группы А, счёт-фактура предоставляется. Уточните в WhatsApp.",
 },
 {
 q: "С какого причала отправляется корпоративный ужин-круиз?",
 a: "Корпоративные ужин-круизы отправляются с пирса Кабаташ (Kabataş) или с Куручешме Марины (Kuruçeşme) — выбор зависит от размера группы и яхты. Точное место посадки подтверждается в WhatsApp после согласования брифа.",
 },
 {
 q: "Что включено в корпоративный ужин-круиз?",
 a: "В пакет включены: вся яхта только для вашей компании, капитан и команда, сервированный ужин, безалкогольные напитки, маршрут по Босфору, лицензия TÜRSAB Группы А, счёт-фактура для бухгалтерии. Опционально — алкоголь, брендинг, фотограф, трансферы. Свяжитесь в WhatsApp.",
 },
 {
 q: "Подходит ли формат для приёма клиентов или VIP-гостей?",
 a: "Да, формат идеально подходит для приёма клиентов, ужинов с топ-менеджментом и VIP-гостями. Закрытая яхта обеспечивает приватность для переговоров, а виды на Босфор создают премиальное впечатление. Согласовать детали можно в WhatsApp.",
 },
];
