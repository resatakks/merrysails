...
const overrides: TourLocaleOverrides = {
  tr: {
    ...
    "yacht-charter-in-istanbul": {
      ...
      importantNotes: [
        "Fiyatlar tekne başınadır ve seçilen yata göre değişir: 12 kişilik butik yat €220/2sa, 15 kişilik premium yat €320/2sa, 40 kişilik grup yatı €380/2sa (Standart) veya €500/2sa (Signature); 90 kişilik etkinlik yatı ve 150 kişilik mega etkinlik yatı özel teklifle. 3 saatten itibaren otomatik %10 indirim. Tam fiyat WhatsApp talebinde grup büyüklüğü ve program detayına göre verilir.",
