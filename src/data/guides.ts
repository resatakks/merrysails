...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "What the Karakoy Meeting Flow Actually Means", content: "The sunset cruise should be treated as a shared premium golden-hour outing, not as a generic pier queue. MerrySails currently uses a Karaköy meeting flow at the ferry pier next to Balıkçı Kemal restaurant, with the final boarding pin confirmed after booking. That distinction matters: the public location logic is useful for planning, but the reservation message is still the source of truth for the exact pin, timing, and final boarding instructions on your date." },
