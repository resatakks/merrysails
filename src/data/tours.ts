...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "How much does a private yacht cost in Istanbul?", answer: "A private Bosphorus yacht charter at MerrySails starts from EUR 220 for a 2-hour sailing on the 12-guest boutique yacht. The per-vessel ladder runs from EUR 220 (boutique 12) through the 15-guest premium yacht (from EUR 320) and the 40-guest group yacht (from EUR 380 Standard, EUR 500 Signature), up to the 90-guest event yacht (from EUR 1,200) and a bespoke quote for the 150-guest mega event yacht. All prices are per yacht, not per guest, so the per-person cost drops significantly for groups. Add-ons such as catering, wine, decoration, DJ, and photographer can be layered on top via a separate brief." },
