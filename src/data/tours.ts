...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "How much does a private yacht cost in Istanbul?", answer: "A private yacht charter on the Bosphorus starts from EUR 280 for a 2-hour cruise (Essential package). The Premium package is EUR 380 and the VIP package is EUR 680. All three prices are per yacht, not per guest, so the per-person cost drops significantly for groups of 4 or more. Add-ons such as catering, wine, decoration, and extra hours can be layered on top of any package during booking." },
      ...
      { question: "Can we hire a yacht for a marriage proposal in Istanbul?", answer: "Yes. The Bosphorus is one of the most iconic proposal locations in the world, and Merry Tourism (TURSAB A Group licensed since 2001) has arranged proposal charters for guests from dozens of countries. Through the add-on menu you can add rose petal decoration, a professional photographer, champagne, a cake, and candlelit table setup. The captain circles the Maiden's Tower during the key moment on request. All proposal extras are available on the Essential, Premium, and VIP yacht packages — VIP gives the most space and the smoothest experience for this type of event." },
      ...
      { question: "What is included in the EUR 280 Essential yacht charter package?", answer: "The Essential Basic Yacht Package at EUR 280 covers: a 2-hour private Bosphorus cruise on a standard-sized yacht, a professional licensed captain and deck crew, complimentary tea, coffee, and water on board. The yacht is exclusively yours for the duration — no other guests. From this base you can add catering, wine and drinks, proposal decoration, a professional photographer, live music, extra hours, or round-trip hotel transfer through the add-on menu at checkout." },
