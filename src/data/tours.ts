...
export const tours: Tour[] = [
  // ========== BOSPHORUS CRUISES ==========
  {
    ...
    */
    route: "Karaköy ferry pier (next to Balıkçı Kemal, by the Marmaray exit) → Dolmabahçe & Ortaköy → First Bosphorus Bridge → Rumeli Hisarı turnaround → return at blue hour",
    departureTime: "19:00 (boarding from 18:30)",
    departurePoint: "Karaköy ferry pier next to Balıkçı Kemal (by the Marmaray exit) — exact boarding berth confirmed by WhatsApp after booking",
    category: "cruise",
    rating: 4.93,
    reviewCount: 621,
    ...
    importantNotes: [
      ...
      "The cruise departs from Karaköy ferry pier Meydanı, next to Balıkçı Kemal — boarding from 18:30, vessel leaves at 19:00",
    ...
    faq: [
      ...
      { question: "Where does the sunset cruise depart from?", answer: "The cruise departs from Karaköy ferry pier, beside Balıkçı Kemal (by the Marmaray exit). Boarding starts at 18:30 and the vessel leaves the pier at 19:00. The exact boarding berth is shared by WhatsApp after booking." },
