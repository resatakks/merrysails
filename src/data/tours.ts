...
export const tours: Tour[] = [
  // ========== BOSPHORUS CRUISES ==========
  {
    ...
    priceMode: "perPerson",
    itinerary: [
      { time: "18:15", title: "Boarding Before Sunset", description: "Meet at the confirmed Bosphorus-side point, board the shared yacht, and settle in before departure." },
      { time: "18:30", title: "Maiden's Tower & Dolmabahce", description: "The route starts with Istanbul's most photogenic southern Bosphorus landmarks while the guide shares historical context." },
      { time: "18:50", title: "Ortakoy & First Bridge", description: "Cruise into the golden-hour stretch where Ortakoy Mosque and the first Bosphorus Bridge frame the skyline." },
      { time: "19:15", title: "Rumeli Fortress at Golden Hour", description: "Reach the upper landmark zone as the sunset color peaks across the water and waterfront mansions." },
      { time: "19:55", title: "Blue-Hour Return", description: "Sail back toward the city lights with drinks and snacks still being served on board." },
    ],
    faq: [
      ...
      { question: "How long does the cruise last?", answer: "The sunset cruise lasts approximately 2 hours and the public booking flow is shown as an 18:30 departure." },
