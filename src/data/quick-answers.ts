...
const REGISTRY: Registry = {
  ...
  "istanbul-dinner-cruise": {
    ...
    ru: {
      ...
      content:
        "Ужин-круиз MerrySails — это 3,5-часовая групповая вечерняя прогулка по Босфору от пирса Кабаташ, четыре пакета: от €30 (Silver, безалкогольные напитки) до €90 (Gold, неограниченный алкоголь). Отправление в 20:30 с трансфером из отеля, турецким ужином, фольклорным шоу и DJ. Лицензия TÜRSAB A с 2001 года (#14316). Бронирование через Telegram @merrysails.",
    },
  },
  ...
  "sunset-cruise-tickets-istanbul": {
    ...
    ru: {
      ...
      content:
        "MerrySails продаёт билеты на круиз по Босфору на закате напрямую на merrysails.com: два варианта — €30–€34 без вина и €35–€40 с вином, оба на одном групповом 2-часовом маршруте от Каракёй ежедневно в 19:00. Без комиссии посредников, мгновенное подтверждение по e-mail. Лицензия TÜRSAB A с 2001 года (#14316). Бронирование через Telegram @merrysails.",
    },
  },
  ...
  "best-bosphorus-cruise-2026": {
    ...
    ru: {
      ...
      content:
        "Лучший круиз по Босфору на 2026 год — групповой закатный рейс MerrySails: 2 часа от пирса Каракёй ежедневно в 19:00, €30–€40 с человека, тот же оператор по лицензии TÜRSAB A (#14316) с 2001 года. Ужин-круизы от €30, аренда яхты от €200. Прямое бронирование через Telegram @merrysails, подтверждение за 60 минут.",
    },
  },
  ...
  "private-bosphorus-dinner-cruise": {
    ...
    ru: {
      ...
      content:
        "Частный ужин-круиз MerrySails — это полностью частная вечерняя аренда яхты от пирса Кабаташ или Каракёй, от €350 за палубу, с индивидуальным турецким меню, винным сопровождением и 3-часовым маршрутом мимо Долмабахче, Ортакёй и Румели Хисары. Вместимость 2–14 гостей. Лицензия TÜRSAB A с 2001 года (#14316). Запрос через Telegram @merrysails, ответ за 60 минут.",
    },
  },
  ...
  "proposal-yacht-rental-istanbul": {
    ...
    ru: {
      ...
      content:
        "Аренда яхты для предложения руки от MerrySails — полностью частная прогулка по Босфору в золотой час от пирса Кабаташ или Каракёй, от €200 за яхту. Опции: фотограф, цветочное оформление, шампанское и тайминг у Девичьей башни. Капитан провёл десятки предложений. Лицензия TÜRSAB A с 2001 года (#14316). Письменный ответ за 60 минут через Telegram @merrysails.",
    },
  },
