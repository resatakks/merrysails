...
export const CURATED_REVIEWS: CuratedReview[] = [
 ...
 text: "Booked the boutique yacht for a marriage proposal. The crew kept the secret perfectly, the photographer captured everything, and the sunset timing was flawless. She said yes. Forever grateful.",
 rating: 5,
 productKey: "yacht",
 },
 {
 ...
 text: "Закатный круиз на Босфоре — идеальный вариант для первого вечера в Стамбуле. €30 в понедельник через WhatsApp забронировали за 10 минут, гид говорил на трёх языках, чай и фрукты бесплатно. Всё ровно как обещали, без сюрпризов.",
 rating: 5,
 productKey: "sunset",
 textByLocale: {
 ru: "Закатный круиз на Босфоре — идеальный вариант для первого вечера в Стамбуле. €30 в понедельник через WhatsApp забронировали за 10 минут, гид говорил на трёх языках, чай и фрукты бесплатно. Всё ровно как обещали, без сюрпризов.",
 },
 },
 ...
 text: "Bachelor party for my best friend — 10 of us on the boutique yacht. Customised playlist, snack tray, and the captain made sure we kept the energy without anything getting out of hand. €220 split 10 ways was very reasonable for a 2-hour private experience.",
 rating: 5,
 productKey: "yacht",
 },
 {
 ...
 text: "Заказали ужин-круиз через WhatsApp (WhatsApp в России недоступен с февраля 2026, спасибо команде за альтернативу). Меню понравилось — мезе, рыба на гриле, баклава. Турецкое шоу с танцем живота и фолклором отлично подходит для семьи. Цена €30 на человека за полный вечер с трансфером — лучшее предложение из всех что нашли.",
 rating: 5,
 productKey: "dinner",
 textByLocale: {
 ru: "Заказали ужин-круиз через WhatsApp (WhatsApp в России недоступен с февраля 2026, спасибо команде за альтернативу). Меню понравилось — мезе, рыба на гриле, баклава. Турецкое шоу с танцем живота и фолклором отлично подходит для семьи. Цена €30 на человека за полный вечер с трансфером — лучшее предложение из всех что нашли.",
 },
 },
 // MORE RU — family
 {
 ...
 text: "С мужем выбрали закатный круиз для нашего первого вечера в Стамбуле. €34 с человека — настоящее открытие после OTA-предложений по €45. Гид говорил на отличном английском, прокомментировал каждую достопримечательность. Бронирование через WhatsApp заняло 10 минут.",
 rating: 5,
 productKey: "sunset",
 textByLocale: {
 ru: "С мужем выбрали закатный круиз для нашего первого вечера в Стамбуле. €34 с человека — настоящее открытие после OTA-предложений по €45. Гид говорил на отличном английском, прокомментировал каждую достопримечательность. Бронирование через WhatsApp заняло 10 минут.",
 },
 },
