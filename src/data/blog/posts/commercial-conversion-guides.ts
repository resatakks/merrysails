  ...
  },
{
    ...
    sections: [
      ...
      },
      {
        ...
        expertQuote: { text: "Gece Boğaz turu, İstanbul'un en iyi tarafını gösterir. Işıklandırılmış saraylar ve köprüler, gündüzden tamamen farklı bir şehir ortaya çıkarır. Bu deneyimi kaçırmamak gerekir.", author: "Kaptan Ahmet Yıldız", title: "MerrySails Baş Kaptan, 20 Yıllık Denizci" }
      },
      {
  ...
  },
{
    ...
    sections: [
      ...
      },
      {
        ...
        expertQuote: { text: "Misafirlere en net tavsiyemiz şu: eğer daha uzun bir özel tur istiyorsanız bunu baştan isteyin. Böylece doğru yat, doğru rota ve doğru süre tek teklif içinde netleşir.", author: "Kaptan Ahmet Yıldız", title: "MerrySails — Operasyon Direktörü" }
      },
      {
  ...
  },
{
    ...
    sections: [
      ...
      },
      {
        ...
        expertQuote: {
          text: "Nisan ve Mayıs aylarında Boğaz'da havanın kıvamı çok güzel olur. Lale festivali sırasında şehrin rengi bambaşka. Bu dönemde yapılan bir gün batımı turu unutulmaz.",
          author: "Kaptan Ahmet Yıldız",
          title: "MerrySails Baş Kaptanı, 22 Yıllık Boğaz Deneyimi",
        },
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        expertQuote: {
          ...
          title: "MerrySails Chief Captain, 22 years on the Bosphorus",
        },
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        expertQuote: {
          ...
          author: "Kaptan Ahmet Yıldız",
          title: "MerrySails — Baş Kaptan, 25 Yıllık Bosphorus Deneyimi",
        },
      },
      {
