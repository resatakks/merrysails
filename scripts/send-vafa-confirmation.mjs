/**
 * One-shot sender for MRY-2026-0032 (Vafa Askarova) custom Princes' Island booking.
 * Re-runnable for similar phone-arranged bookings by editing the constants below.
 *
 * Fetches the live voucher + invoice PDFs from production, then sends a
 * minimal English confirmation email with both as attachments.
 *
 * Usage: node --env-file=.env.local scripts/send-vafa-confirmation.mjs
 */
