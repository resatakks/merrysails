...
const EN_URLS = [
  ...
  "/nl/bosphorus-cruise-from-sultanahmet",
  "/nl/bosphorus-cruise-from-taksim",
  "/nl/bosphorus-cruise-from-beyoglu",
  "/ru/bosphorus-cruise-from-sultanahmet",
  "/ru/bosphorus-cruise-from-taksim",
