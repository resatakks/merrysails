/**
 * One-shot sender for MRY-2026-0039 (Nathan Furr) custom Bosphorus Tour booking.
 * Mirrors scripts/send-vafa-confirmation.mjs.
 *
 * Usage: node --env-file=.env.local scripts/send-nathan-furr-confirmation.mjs
 */
import nodemailer from "nodemailer";

const RESERVATION_ID = "MRY-2026-0039";
const SITE_BASE = "https://merrysails.com";

const TO = "nathan.furr@insead.edu";
const CC = [
  "info@merrysails.com",
