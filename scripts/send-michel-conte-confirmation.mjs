/**
 * One-shot sender for MRY-2026-0045 (Michel Conte) custom Private Sunset Cruise booking.
 * Mirrors scripts/send-nathan-furr-confirmation.mjs.
 *
 * Usage: node --env-file=.env.local scripts/send-michel-conte-confirmation.mjs
 */
import nodemailer from "nodemailer";

const RESERVATION_ID = "MRY-2026-0045";
const SITE_BASE = "https://merrysails.com";

const TO = "contemichel1976@gmail.com";
const CC = [
  "info@merrysails.com",
...
const TEMPLATE = {
  ...
  pickup: "Karaköy · 20:00 – 22:00",
  totalDisplay: "€200.00",
  customerPhone: "+33 6 98 64 50 04",
  paymentNote: "Payment: €200 EUR cash on board.",
  meetingPointNote:
